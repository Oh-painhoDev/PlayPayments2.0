 ...
 * 
 * Acesse via: http://localhost:8000/api/test-api-transaction.php
 * 
 * ANTES DE USAR:
        ...
        <div class="container">
            ...
            <?php if ($apiSecret === 'sk_SEU_TOKEN_AQUI'): ?>
                <div class="warning">
                    ...
                    <p>Encontre seu token em: <strong>Configurações → API Keys → Chave Secreta</strong></p>
                </div>
            <?php endif; ?>
                ...
                <div class="info <?= $isSuccess ? 'success' : 'error' ?>">
                    ...
                    <?php if ($isSuccess): ?>
                        ...
                        <?php if (isset($responseData['transaction'])): ?>
                            ...
                            <?php if (isset($responseData['pix']) && $responseData['pix']): ?>
                                <p><strong>Código PIX:</strong> <?= htmlspecialchars(substr($responseData['pix']['code'] ?? '', 0, 50)) ?>...</p>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php else: ?>
                        <p><strong>Erro:</strong> <?= htmlspecialchars($responseData['error'] ?? 'Erro desconhecido') ?></p>
