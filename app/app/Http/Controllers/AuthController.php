...
class AuthController extends Controller
{
    ...
    public function showRegister(Request $request)
    {
        ...
        return view('auth.register', ['referral_code' => $referralCode]); // View simplificada com apenas 4 campos básicos
    }
    ...
    public function register(Request $req)
    {
        try {
            ...
            try {
                ...
                $referrerId = null;
                if ($req->has('ref')) {
                    $referralCode = $req->get('ref');
                } elseif ($req->has('referral_code')) {
                    $referralCode = $req->get('referral_code');
                } else {
                    $referralCode = null;
                }
