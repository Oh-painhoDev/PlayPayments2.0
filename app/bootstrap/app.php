...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        then: function () {
            ...
            // Carregar rotas do subdomínio APP se o arquivo existir
            // Estas rotas são carregadas ANTES das rotas principais para ter prioridade
            // Elas só funcionam no subdomínio APP (app.playpayments.com)
            // IMPORTANTE: Esta pasta (app/) é apenas para aplicação web, então só carrega rotas web
            if (file_exists(base_path('routes/app-subdomain.php'))) {
                require base_path('routes/app-subdomain.php');
            }
        },
    )
