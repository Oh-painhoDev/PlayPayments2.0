                ...
                <div class="box-border content-stretch flex flex-col gap-2.5 items-start justify-center px-4 py-2.5 relative rounded-lg shrink-0 w-full md:w-auto">
                    <div class="grid gap-2 w-full">
                        <form method="GET" action="<?php echo e(route('transactions.index')); ?>" class="flex gap-2">
                            ...
                            <input type="date" name="date_from" value="<?php echo e(request('date_from', \Carbon\Carbon::now()->subDays(30)->format('Y-m-d'))); ?>" class="px-3 py-2 bg-[#161616] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37]">
                            <span class="px-2 py-2 text-[#AAAAAA] text-sm">até</span>
                            <input type="date" name="date_to" value="<?php echo e(request('date_to', \Carbon\Carbon::now()->format('Y-m-d'))); ?>" class="px-3 py-2 bg-[#161616] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37]">
                                    ...
                                    <div class="flex flex-row gap-6 items-center w-full">
                                        ...
                                        <div class="w-[220px]">
                                            <div class="flex items-center gap-2">
                                                <p class="text-[11px] font-semibold tracking-[-0.24px]" style="color: #D4AF37;">ID: <?php echo e($transaction->transaction_id); ?></p>
                                                <button type="button" onclick="event.stopPropagation(); copyTransactionId('<?php echo e($transaction->transaction_id); ?>')" class="inline-flex items-center justify-center hover:opacity-70 transition-opacity" title="Copiar ID">
                                        ...
                                        <!-- Origem -->
                                        <div class="w-[110px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white"><?php echo e($originLabel === 'Checkout' ? 'Checkout API' : 'API Pública'); ?></p>
    </div>

                                        <!-- Produto -->
                                        <div class="w-[150px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white truncate" title="<?php echo e($transactionTitle); ?>"><?php echo e(\Illuminate\Support\Str::limit($transactionTitle, 30)); ?></p>
                                        </div>

                                        <!-- Cliente -->
                                        <div class="w-[220px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] leading-[1.3] text-white"><?php echo e($transaction->customer_data['name'] ?? 'N/A'); ?></p>
                                            <p class="text-[11px] font-semibold tracking-[-0.24px] leading-[1.3] text-[#707070]"><?php echo e($transaction->customer_data['email'] ?? 'N/A'); ?></p>
                                            <?php if(!empty($transaction->customer_data['phone'])): ?>
                                                <p class="text-[11px] font-semibold tracking-[-0.24px] leading-[1.3] text-[#707070]"><?php echo e($transaction->customer_data['phone']); ?></p>
                                            <?php endif; ?>
    </div>
                                        ...
                                        <div class="w-[150px]">
                                            <div class="flex items-center gap-3">
                                                <div class="w-10 h-10 rounded-full bg-[#0d0d0d] flex items-center justify-center border border-[#1f1f1f]">
                                                    <img src="<?php echo e($paymentVisual['image']); ?>" alt="<?php echo e($paymentVisual['label']); ?>" class="h-6 w-6 object-contain">
                                                </div>
                                                <div>
                                                    <p class="text-xs font-semibold tracking-[-0.24px] text-white"><?php echo e($paymentVisual['label']); ?></p>
                                                    <p class="text-[11px] font-semibold tracking-[-0.24px]" style="color: <?php echo e($config['color']); ?>"><?php echo e($config['label']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Valor total -->
                                        <div class="w-[140px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white">R$ <?php echo e(number_format($transaction->amount, 2, ',', '.')); ?></p>
                                        </div>

                                        <!-- Recebimento -->
                                        <div class="w-[150px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white">R$ <?php echo e(number_format($netAmount, 2, ',', '.')); ?></p>
                                            <p class="text-[11px] font-semibold tracking-[-0.24px] <?php echo e($receivedAt ? 'text-[#10b981]' : 'text-[#707070]'); ?>">
                                                <?php echo e($receivedAt ?? 'Pendente'); ?>
                                        ...
                                        <!-- Hora -->
                                        <div class="w-[120px]">
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white"><?php echo e($transaction->created_at->format('d/m/Y')); ?></p>
                                            <p class="text-[11px] font-semibold tracking-[-0.24px] text-[#707070]"><?php echo e($transaction->created_at->format('H:i:s')); ?></p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="flex flex-col gap-3 items-start justify-start relative shrink-0 w-full">
                    <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            ...
                            $receivedAt = $transaction->paid_at ? $transaction->paid_at->format('d/m/Y H:i') : null;
                                ?>
                        <div class="box-border flex flex-col gap-3 p-4 rounded-lg w-full cursor-pointer bg-[#1f1f1f]" onclick="window.location.href='<?php echo e(route('transactions.show', $transaction->transaction_id)); ?>'">
                            <div class="flex items-start justify-between w-full">
                                <div>
                                    <div class="flex items-center gap-2">
                                        <p class="text-[11px] font-semibold" style="color: #D4AF37;">ID: <?php echo e($transaction->transaction_id); ?></p>
                                        <button type="button" onclick="event.stopPropagation(); copyTransactionId('<?php echo e($transaction->transaction_id); ?>')" class="inline-flex items-center justify-center hover:opacity-70 transition-opacity" title="Copiar ID">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-copy h-3.5 w-3.5" style="color: #D4AF37;">
                                                <rect width="14" height="14" x="8" y="8" rx="2" ry="2"></rect>
                                                <path d="M4 16c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2h8c1.1 0 2 .9 2 2"></path>
                                ...
                                <div class="px-3 py-1 rounded-full bg-[#161616]">
                                    <span class="text-[11px] font-semibold" style="color: <?php echo e($config['color']); ?>"><?php echo e($config['label']); ?></span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-3 w-full text-[11px] text-[#dddddd]">
                                <div>
                                    ...
                                    <span class="mt-1 block"><?php echo e($originLabel === 'Checkout' ? 'Checkout API' : 'API Pública'); ?></span>
                                </div>
                                <div>
                                    <p class="text-[#707070] uppercase tracking-[0.1em] text-[10px]">Valor total</p>
                                    <p class="mt-1 text-white font-semibold">R$ <?php echo e(number_format($transaction->amount, 2, ',', '.')); ?></p>
                                </div>
                                <div>
                                    <p class="text-[#707070] uppercase tracking-[0.1em] text-[10px]">Produto</p>
                                    <p class="mt-1 text-white font-semibold"><?php echo e(\Illuminate\Support\Str::limit($transactionTitle, 28)); ?></p>
                                </div>
                                <div>
                                    <p class="text-[#707070] uppercase tracking-[0.1em] text-[10px]">Cliente</p>
                                    <p class="mt-1 text-white font-semibold"><?php echo e($transaction->customer_data['name'] ?? 'N/A'); ?></p>
                                    <p class="text-[#707070]"><?php echo e($transaction->customer_data['email'] ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        <div class="w-8 h-8 rounded-full bg-[#0d0d0d] flex items-center justify-center border border-[#1f1f1f]">
                                            <img src="<?php echo e($paymentVisual['image']); ?>" alt="<?php echo e($paymentVisual['label']); ?>" class="h-5 w-5 object-contain">
                                        </div>
                                        <div>
                                            <p class="text-white font-semibold leading-4"><?php echo e($paymentVisual['label']); ?></p>
                                            <p class="text-[11px]" style="color: <?php echo e($config['color']); ?>"><?php echo e($config['label']); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <p class="text-[#707070] uppercase tracking-[0.1em] text-[10px]">Recebimento</p>
                                    <p class="mt-1 text-white font-semibold">R$ <?php echo e(number_format($netAmount, 2, ',', '.')); ?></p>
                                    <p class="<?php echo e($receivedAt ? 'text-[#10b981]' : 'text-[#707070]'); ?>"><?php echo e($receivedAt ?? 'Pendente'); ?></p>
                                    </div>
                                <div>
                                    <p class="text-[#707070] uppercase tracking-[0.1em] text-[10px]">Hora</p>
                                    <p class="mt-1 text-white font-semibold"><?php echo e($transaction->created_at->format('d/m/Y')); ?></p>
                                    <p class="text-[#707070]"><?php echo e($transaction->created_at->format('H:i:s')); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/transactions/index.blade.php ENDPATH**/ ?>