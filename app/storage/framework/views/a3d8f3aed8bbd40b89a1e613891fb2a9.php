...
<section class="bg-view">
    <div class="p-5">
        <div class="max-w-[1600px] mx-auto">
                ...
                <div class="flex flex-col gap-6 mb-8">
                    ...
                    <div class="flex items-start gap-6">
                        <div class="flex-shrink-0 w-16 h-16 rounded-xl p-3 bg-gradient-to-br from-gray-800/30 to-transparent">
                            ...
                            <div style="display: none; color: #D4AF37; font-weight: bold; font-size: 20px; text-align: center; line-height: 48px;">UTMify</div>
                        </div>
                        <div>
            ...
            <!-- FAQ Section -->
            <div class="mt-8 text-card-foreground shadow-sm overflow-hidden bg-[#161616] border border-white/5 rounded-2xl">
                <div class="p-6">
                    <h3 class="font-['Manrope'] font-medium text-[20px] tracking-[-0.32px] text-white flex items-center gap-2 mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-help-circle"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                        Dúvidas Frequentes (FAQ)
                    </h3>
                    
                    <div class="space-y-4">
                        <div class="group border border-white/5 rounded-xl bg-[#1F1F1F] overflow-hidden">
                            <details class="group-open:bg-[#252525] transition-colors p-4 cursor-pointer" open>
                                <summary class="font-['Manrope'] font-semibold text-white text-[15px] outline-none flex justify-between items-center">
                                    Quais métodos de pagamento são enviados para a UTMify?
                                    <svg class="w-5 h-5 text-[#D4AF37] transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                </summary>
                                <div class="mt-4 text-[#AAAAAA] text-sm leading-relaxed font-['Manrope'] border-t border-white/5 pt-4">
                                    A integração suporta automaticamente <strong>PIX</strong>, <strong>Cartão de Crédito</strong> e <strong>Boleto (Bank Slip)</strong>. O status da transação será sincronizado em tempo real quando as vendas forem criadas (Aguardando Pagamento/Waiting Payment) ou aprovadas (Pagos/Paid), além de Reembolsos e Cancelamentos.
                                </div>
                            </details>
                        </div>

                        <div class="group border border-white/5 rounded-xl bg-[#1F1F1F] overflow-hidden">
                            <details class="group-open:bg-[#252525] transition-colors p-4 cursor-pointer">
                                <summary class="font-['Manrope'] font-semibold text-white text-[15px] outline-none flex justify-between items-center">
                                    Onde encontro meu Token da API UTMify?
                                    <svg class="w-5 h-5 text-[#D4AF37] transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                </summary>
                                <div class="mt-4 text-[#AAAAAA] text-sm leading-relaxed font-['Manrope'] border-t border-white/5 pt-4">
                                    Para gerar o seu API Token, acesse sua conta na UTMify, vá em <strong>Configurações > Tokens / Credenciais de API</strong> e crie uma nova restrita apenas a API de Vendas (Orders). Copie a chave (geralmente uma string longa) e cole no formulário acima. O token é invisível para outros usuários.
                                </div>
                            </details>
                        </div>
                        ...
                        <div class="group border border-white/5 rounded-xl bg-[#1F1F1F] overflow-hidden">
                            <details class="group-open:bg-[#252525] transition-colors p-4 cursor-pointer">
                                <summary class="font-['Manrope'] font-semibold text-white text-[15px] outline-none flex justify-between items-center">
                                    Como os parâmetros de UTM são rastreados?
                                    <svg class="w-5 h-5 text-[#D4AF37] transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                </summary>
                                <div class="mt-4 text-[#AAAAAA] text-sm leading-relaxed font-['Manrope'] border-t border-white/5 pt-4">
                                    Nossa plataforma captura automaticamente todos os parâmetros presentes no Checkout (src, sck, utm_source, utm_campaign, utm_medium, utm_content, utm_term) e os incorpora aos "metadata" ou "payment_data". Esses rastreadores são empacotados e enviados diretamente no padrão da UTMify. Certifique-se de usar URLs com parâmetros válidos em suas campanhas!
                                </div>
                            </details>
                        </div>
                        ...
                        <div class="group border border-white/5 rounded-xl bg-[#1F1F1F] overflow-hidden">
                            <details class="group-open:bg-[#252525] transition-colors p-4 cursor-pointer">
                                <summary class="font-['Manrope'] font-semibold text-white text-[15px] outline-none flex justify-between items-center">
                                    As comissões e taxas são enviadas corretamente?
                                    <svg class="w-5 h-5 text-[#D4AF37] transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                </summary>
                                <div class="mt-4 text-[#AAAAAA] text-sm leading-relaxed font-['Manrope'] border-t border-white/5 pt-4">
                                    Sim, para garantir um ROI perfeito na UTMify enviamos: Valor Bruto (totalPriceInCents), Valor Líquido/Sua Comissão (userCommissionInCents) e as Taxas de Gateway (gatewayFeeInCents). Se por ventura a taxa for isenta, a plataforma se ajusta para refletir 100% da comissão no dashboard da UTMify.
                                </div>
                            </details>
                        </div>
                    </div>
        ...
        <form id="utmifyForm" method="POST" action="" class="mt-6 flex flex-col gap-6">
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-col gap-1.5">
                    <input name="name" id="integrationName" type="text" class="flex h-10 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-full rounded-xl border-2 bg-[#1f1f1f] border-[#2a2a2a] text-white placeholder:text-[#707070] focus:border-[#D4AF37]" placeholder="Nome do UTM" value="" required>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-col gap-1.5">
                    <input name="api_token" id="apiToken" type="text" class="flex h-10 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-full rounded-xl border-2 bg-[#1f1f1f] border-[#2a2a2a] text-white placeholder:text-[#707070] focus:border-[#D4AF37]" placeholder="Token da API UTMify" value="" required>
                    <p class="text-xs text-[#707070]">
                        <strong>Obrigatório:</strong> Obtenha seu token em: <a href="https://utmify.com.br/register" target="_blank" class="text-[#D4AF37] hover:underline">utmify.com.br</a><br>
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-col gap-1.5">
                    <input name="platform_name" id="platformName" type="text" class="flex h-10 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-full rounded-xl border-2 bg-[#1f1f1f] border-[#2a2a2a] text-white placeholder:text-[#707070] focus:border-[#D4AF37]" placeholder="Ex: playpayments, GlobalPay, MeuNegocio" value="">
                    <p class="text-xs text-[#707070]">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between rounded-xl p-4 bg-[#1f1f1f]">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="w-10 h-5 bg-[#161616] peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#D4AF37] rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-[#AAAAAA] after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#D4AF37]"></div>
                    </label>
                </div>
                <div class="flex items-center justify-between rounded-xl p-4 bg-[#1f1f1f]">
