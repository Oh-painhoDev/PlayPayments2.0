                                    ...
                                    <tr class="hover:bg-[#1f1f1f] transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <?php endif; ?>
                                                <?php if($dispute->status !== 'pending'): ?>
                                                    <button onclick="openDisputeDetailsModal(<?php echo e($dispute->id); ?>)" class="text-[#D4AF37] hover:text-[#D4AF37] text-xs font-semibold">
                                                        Ver Detalhes
                                                    </button>
                                                <?php endif; ?>
                                            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/refunds/index.blade.php ENDPATH**/ ?>