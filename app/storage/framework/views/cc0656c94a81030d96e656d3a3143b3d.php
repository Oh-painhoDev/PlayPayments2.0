...
<?php $__env->startSection('page-description', 'Visão geral do seu negócio'); ?>
...
<section class="bg-view">
    ...
    <div class="dashboard-header">
        <div class="dashboard-header-content">
            <div class="dashboard-header-left">
                ...
                <p class="dashboard-date" id="dashboardDate"><?php echo e(\Carbon\Carbon::now()->locale('pt_BR')->translatedFormat('l, d \d\e F \d\e Y')); ?></p>
            </div>
            <div class="dashboard-header-right">
                <button class="date-selector-btn" id="dateSelectorBtn" type="button">
                    ...
                    <span class="date-selector-text" id="dateSelectorText">
                        <?php echo e($startDate->format('d')); ?> de <?php echo e(strtolower($startDate->locale('pt_BR')->translatedFormat('M'))); ?> de <?php echo e($startDate->format('Y')); ?> - <?php echo e($endDate->format('d')); ?> de <?php echo e(strtolower($endDate->locale('pt_BR')->translatedFormat('M'))); ?> de <?php echo e($endDate->format('Y')); ?>
    ...
    <div class="mb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 hover:border-[#D4AF37]/50 transition-all duration-300 shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#D4AF37]">R$ <?php echo e(number_format($netValue ?? 0, 2, ',', '.')); ?></p>
            ...
            <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 hover:border-[#FF9D3A]/50 transition-all duration-300 shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#FF9D3A]">R$ <?php echo e(number_format($totalSales ?? 0, 2, ',', '.')); ?></p>
            ...
            <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 hover:border-[#FFE5A0]/50 transition-all duration-300 shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#FFE5A0]">R$ <?php echo e(number_format($pendingSales ?? 0, 2, ',', '.')); ?></p>
            ...
            <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 hover:border-[#FF8C5A]/50 transition-all duration-300 shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#FF8C5A]">R$ <?php echo e(number_format($averageTicket ?? 0, 2, ',', '.')); ?></p>
            ...
            <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 hover:border-[#D4AF37]/50 transition-all duration-300 shadow-sm">
                ...
                <p class="text-2xl font-bold text-white"><?php echo e($paidTransactions ?? 0); ?></p>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('wallet.index')); ?>" class="group bg-gradient-to-br from-[#1a1a1a] to-[#161616] rounded-xl border border-[#21b3dd]/30 hover:border-[#21b3dd] p-5 transition-all duration-300 shadow-lg hover:shadow-[#21b3dd]/20">
                <div class="flex items-center gap-4 mb-3">
            ...
            <!-- Card: Transações -->
            <a href="<?php echo e(route('transactions.index')); ?>" class="group bg-gradient-to-br from-[#1a1a1a] to-[#161616] rounded-xl border border-[#10B981]/30 hover:border-[#10B981] p-5 transition-all duration-300 shadow-lg hover:shadow-[#10B981]/20">
                <div class="flex items-center gap-4 mb-3">
            ...
            <a href="<?php echo e(route('api-key')); ?>" class="group bg-gradient-to-br from-[#1a1a1a] to-[#161616] rounded-xl border border-[#EF4444]/30 hover:border-[#EF4444] p-5 transition-all duration-300 shadow-lg hover:shadow-[#EF4444]/20">
                <div class="flex items-center gap-4 mb-3">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 shadow-lg flex flex-col justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white">R$ <?php echo e(number_format($pendingSales ?? 0, 2, ',', '.')); ?></p>
            </div>
            <div class="border-t border-[#333333] mt-4 pt-4">
                <div class="flex items-center justify-between">
                    <p class="text-xs text-[#707070]"><?php echo e(\App\Models\Transaction::where('user_id', Auth::id())->whereIn('status', ['pending', 'waiting_payment'])->count()); ?> cobranças</p>
                    <p class="text-xs font-bold text-[#a1a1aa]"><?php echo e(number_format(($pendingSales ?? 0) > 0 && ($totalSales ?? 0) > 0 ? (($pendingSales / ($totalSales + $pendingSales)) * 100) : 0, 2, ',', '.')); ?>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 shadow-lg flex flex-col justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white">R$ <?php echo e(number_format($refundedAmount ?? 0, 2, ',', '.')); ?></p>
            </div>
            <div class="border-t border-[#333333] mt-4 pt-4">
                <div class="flex items-center justify-between">
                    <p class="text-xs text-[#707070]"><?php echo e($refundedCount ?? 0); ?> cobranças</p>
                    <p class="text-xs font-bold text-[#a1a1aa]"><?php echo e(number_format($refundedPercentage ?? 0, 2, ',', '.')); ?>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 shadow-lg flex flex-col justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white">R$ <?php echo e(number_format($chargebackAmount ?? 0, 2, ',', '.')); ?></p>
            </div>
            <div class="border-t border-[#333333] mt-4 pt-4">
                <div class="flex items-center justify-between">
                    <p class="text-xs text-[#707070]"><?php echo e($chargebackCount ?? 0); ?> cobranças</p>
                    <p class="text-xs font-bold text-[#a1a1aa]"><?php echo e(number_format($chargebackPercentage ?? 0, 2, ',', '.')); ?>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#1a1a1a] rounded-xl border border-[#333333] p-5 shadow-lg flex flex-col justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white">R$ <?php echo e(number_format($cancelledAmount ?? 0, 2, ',', '.')); ?></p>
            </div>
            <div class="border-t border-[#333333] mt-4 pt-4">
                <div class="flex items-center justify-between">
                    <p class="text-xs text-[#707070]"><?php echo e($cancelledCount ?? 0); ?> cobranças</p>
                    <p class="text-xs font-bold text-[#a1a1aa]"><?php echo e(number_format($cancelledPercentage ?? 0, 2, ',', '.')); ?>%</p>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="w-full px-4 py-3">
                                        <div class="w-full flex items-center gap-6">
                                            ...
                                            <div class="flex-[2] min-w-[200px]">
                                                <p class="text-xs font-semibold tracking-[-0.24px] leading-[1.3] text-white"><?php echo e($customerName); ?></p>
                                                <p class="text-xs font-semibold tracking-[-0.24px] leading-[1.3] text-[#707070]"><?php echo e($customerEmail); ?></p>
                                            </div>
                                            <div class="flex-[1.5] min-w-[150px]">
                                                <div class="flex flex-col gap-1">
                                                    <div class="px-3 py-1 rounded inline-flex items-center gap-1 size-fit bg-[#161616]">
                                                        <?php if(strtolower($paymentMethod) == 'pix'): ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <span class="font-['Manrope'] font-semibold text-[12px] tracking-[-0.24px] text-[#707070]"><?php echo e($paymentMethod); ?></span>
                                                    </div>
                                                    <p class="text-xs font-semibold tracking-[-0.28px] text-white">R$ <?php echo e(number_format($transaction->amount ?? 0, 2, ',', '.')); ?></p>
                                                </div>
                                            </div>
                                            <div class="flex-1 min-w-[80px]">
                                                <div class="px-3 py-1 rounded flex items-center justify-center bg-[#161616]">
                                                    <span class="text-xs font-semibold tracking-[-0.24px] text-center" style="color: <?php echo e($statusColor); ?>;"><?php echo e($status); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full px-4 py-3 border-b border-[#1F1F1F]">
                                        <div class="w-full flex items-center gap-2">
                                            ...
                                            <div class="flex-[2] min-w-0">
                                                <p class="text-[10px] font-semibold tracking-[-0.24px] leading-[1.3] text-white truncate"><?php echo e($customerName); ?></p>
                                                <p class="text-[10px] font-semibold tracking-[-0.24px] leading-[1.3] text-[#707070] truncate"><?php echo e($customerEmail); ?></p>
                                            </div>
                                            <div class="flex-[1.5] min-w-0">
                                                <div class="flex flex-col gap-1">
                                                    <div class="px-2 py-0.5 rounded inline-flex items-center gap-1 size-fit bg-[#161616]">
                                                        ...
                                                        <?php endif; ?>
                                                        <span class="font-['Manrope'] font-semibold text-[10px] tracking-[-0.24px] text-[#707070]"><?php echo e($paymentMethod); ?></span>
                                                    </div>
                                                    <p class="text-[10px] font-semibold tracking-[-0.24px] text-white">R$ <?php echo e(number_format($transaction->amount ?? 0, 2, ',', '.')); ?></p>
                                                </div>
                                            </div>
                                            <div class="flex-1">
                                                <div class="px-2 py-0.5 rounded flex items-center justify-center bg-[#161616]">
                                                    <span class="text-[10px] font-semibold tracking-[-0.24px] text-center" style="color: <?php echo e($statusColor); ?>;"><?php echo e($status); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="deposit-qr-section">
                    ...
                    <div class="deposit-qr-wrapper">
                        <div class="deposit-qr-code">
                            ...
                            <img src="<?php echo e(asset('favicon.svg')); ?>" class="deposit-qr-logo" alt="Logo" id="qrLogoFavicon">
                        </div>
                    </div>
...
<link rel="stylesheet" href="<?php echo e(asset('css/deposit-modal.css')); ?>">
<style>
    .globe-filters {
        background: #161616;
        padding: 16px;
...
<?php if(request()->routeIs('dashboard')): ?>
<script>
window.depositCreateRoute = '<?php echo e(route('deposit.create')); ?>';
window.depositStatusRoute = '<?php echo e(route('deposit.status', ['transaction' => ':id'])); ?>';
</script>
<script src="<?php echo e(asset('js/deposit-modal.js')); ?>"></script>
<?php endif; ?>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script src="https://unpkg.com/globe.gl"></script>
<script>
// Dados de localização das vendas (inicial)
window.salesLocations = <?php echo json_encode($salesLocations ?? []); ?>;
window.globeFilters = {
    showPaid: true,
    showPending: true,
    dateFrom: '<?php echo e($startDate->format('Y-m-d')); ?>',
    dateTo: '<?php echo e($endDate->format('Y-m-d')); ?>'
};
// Inicializar datas do globo
window.globeSelectedStartDate = '<?php echo e($startDate->format('Y-m-d')); ?>';
window.globeSelectedEndDate = '<?php echo e($endDate->format('Y-m-d')); ?>';
console.log('Vendas carregadas:', window.salesLocations);
window.dashboardSalesData = <?php echo json_encode($salesChartData ?? []); ?>;
window.dashboardStartDate = '<?php echo e($startDate->format('Y-m-d')); ?>';
window.dashboardEndDate = '<?php echo e($endDate->format('Y-m-d')); ?>';
window.dashboardRoute = '<?php echo e(route('dashboard')); ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (dateSelectorBtn && datePickerModal) {
        dateSelectorBtn.addEventListener('click', function(e) {
            e.preventDefault();
            selectedStartDate = '<?php echo e($startDate->format('Y-m-d')); ?>';
            selectedEndDate = '<?php echo e($endDate->format('Y-m-d')); ?>';
            updateCalendar();
            updateApplyButton();
    ...
    function initGlobe() {
        ...
        try {
            ...
            window.reloadGlobeSales = function() {
                ...
                let dateFrom = urlParams.get('date_from') || '<?php echo e($startDate->format('Y-m-d')); ?>';
                let dateTo = urlParams.get('date_to') || '<?php echo e($endDate->format('Y-m-d')); ?>';
                
                // Buscar dados (todas as vendas - cores automáticas)
                fetch(`<?php echo e(route('api.globe.sales')); ?>?date_from=${dateFrom}&date_to=${dateTo}`)
                    .then(res => res.json())
                    .then(data => {
                        if (data.success) {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/dashboard.blade.php ENDPATH**/ ?>