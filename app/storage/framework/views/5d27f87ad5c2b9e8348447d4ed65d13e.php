                                    ...
                                    <tr class="hover:bg-[#1f1f1f] transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2">
                                                <input type="text" value="<?php echo e($link->checkout_url); ?>" readonly onclick="this.select()" class="px-3 py-1.5 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-xs font-mono w-[300px] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]">
                                                <button onclick="copyToClipboard('<?php echo e($link->checkout_url); ?>')" class="px-3 py-1.5 bg-[#1f1f1f] hover:bg-[#2d2d2d] border border-[#2d2d2d] rounded-lg text-[#D4AF37] text-xs font-semibold transition-colors">
                                                    Copiar
                                                </button>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                <button onclick="getIntegrationCode('<?php echo e($link->slug); ?>')" class="px-3 py-1.5 bg-[#1f1f1f] hover:bg-[#2d2d2d] border border-[#2d2d2d] rounded-lg text-[#D4AF37] text-xs font-semibold transition-colors">
                                                    Código
                                                </button>
                    ...
                    <div id="modalPreviewContainer" class="bg-[#1f1f1f] border border-[#2d2d2d] rounded-xl p-6">
                        <div class="text-center space-y-4">
                            ...
                            <div class="bg-[#161616] border border-[#2d2d2d] rounded-lg p-4">
                                ...
                                <p id="previewLink" class="text-xs font-mono text-[#D4AF37] break-all"><?php echo e(url('/checkout')); ?>/...</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/payment-links/index.blade.php ENDPATH**/ ?>