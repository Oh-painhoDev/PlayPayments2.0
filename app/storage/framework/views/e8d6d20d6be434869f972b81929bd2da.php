                                                ...
                                                <div class="relative">
                                                    <div class="w-20 h-20 rounded-full overflow-hidden bg-[#1F1F1F] flex items-center justify-center">
                                                        ...
                                                        <?php if($hasPhoto && $photoUrl): ?>
                                                            <img src="<?php echo e($photoUrl); ?>" alt="Foto de perfil" class="w-full h-full object-cover" id="user-photo-img">
                                                        <?php else: ?>
...
function handlePhotoUpload(event) {
    ...
    fetch('<?php echo e(route("settings.photo.update")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/settings/index.blade.php ENDPATH**/ ?>