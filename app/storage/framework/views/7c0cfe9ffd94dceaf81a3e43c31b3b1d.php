                ...
                <ul class="space-y-4" id="webhooksList">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $webhooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webhook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="webhook-item bg-[#1f1f1f] rounded-lg p-4 border border-[#2d2d2d] hover:border-[#D4AF37]/50 transition-colors" data-description="<?php echo e(strtolower($webhook->description ?? '')); ?>" data-url="<?php echo e(strtolower($webhook->url)); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/painhodev/PlayPayments2.0/app/resources/views/webhooks/index.blade.php ENDPATH**/ ?>