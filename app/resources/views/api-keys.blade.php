...
@section('page-title', 'Chaves API')
@section('page-description', 'Gerencie suas chaves de API com segurança')
...
<div class="api-keys-wrapper">
    ...
    <div class="container mx-auto px-8">
        <div class="max-w-[1200px] mx-auto space-y-6">
            <div class="space-y-4">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-refresh-ccw h-4 w-4 text-[#D4AF37]">
            ...
            <div class="space-y-4" x-data="{ activeTab: 'keys' }">
                <div role="tablist" class="inline-flex h-10 items-center justify-center rounded-md text-muted-foreground p-1 bg-[#161616]">
                    <button 
                        ...
                        :class="activeTab === 'keys' ? 'bg-[#1f1f1f] text-[#D4AF37]' : 'text-white'"
                    ...
                    <button 
                        ...
                        :class="activeTab === 'example' ? 'bg-[#1f1f1f] text-[#D4AF37]' : 'text-white'"
                        class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow-sm gap-1"
                    >
                ...
                <div x-show="activeTab === 'keys'" class="space-y-4">
                    <div class="flex flex-col md:flex-row gap-4 items-start justify-start w-full">
                        <!-- Secret Key Card -->
                        <div class="rounded-lg text-card-foreground shadow-sm border-2 transition-all duration-200 flex-1 w-full bg-[#161616] border-[#2d2d2d] hover:border-[#D4AF37]/20">
                            <div class="p-6 flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                >
                                    <svg id="secretKeyEyeIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye h-4 w-4 text-[#D4AF37]">
                            ...
                            <div class="p-6 pt-0">
                                <div class="flex items-center gap-4 w-full">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex flex-col gap-1.5">
                                            <input 
                                                ...
                                                readonly 
                                                type="password" 
                                                value="{{ $user->api_secret ?? 'Nenhuma chave gerada' }}"
                                                style="min-width: 100%; word-break: break-all;"
                                            >
                                        </div>
                                    </div>
                                    <button 
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-copy h-3.5 w-3.5 text-[#D4AF37]">
                        ...
                        <div class="rounded-lg text-card-foreground shadow-sm border-2 transition-all duration-200 flex-1 w-full bg-[#161616] border-[#2d2d2d] hover:border-[#D4AF37]/20">
                            <div class="p-6 flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <button 
                                    ...
                                    class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:text-accent-foreground rounded-[8px] h-8 w-8 p-0 hover:bg-transparent"
                                >
                                    <svg id="publicKeyEyeIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye h-4 w-4 text-[#D4AF37]">
                                        <path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path>
                                        <circle cx="12" cy="12" r="3"></circle>
                                    </svg>
                                </button>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex flex-col gap-1.5">
                                            <input 
                                                ...
                                                readonly 
                                                type="password" 
                                                value="{{ $user->api_public_key ?? 'Nenhuma chave gerada' }}"
                                                style="min-width: 100%; word-break: break-all;"
                                            >
                                        </div>
                                    </div>
  ...
  -H "Authorization: Bearer {{ $user->api_secret ?? 'SUA_CHAVE_SECRETA' }}" \
  ...
  -H "Authorization: Bearer {{ $user->api_secret ?? 'SUA_CHAVE_SECRETA' }}"</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
...
function generateNewKey() {
    if (confirm('Tem certeza que deseja gerar uma nova chave? A chave atual será invalidada.')) {
        ...
        form.method = 'POST';
        form.action = '{{ route("settings.api.generate") }}';
