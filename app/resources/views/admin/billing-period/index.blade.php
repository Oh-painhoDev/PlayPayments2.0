...
@section('title', 'Faturamento por Período')
@section('page-title', 'Faturamento por Período')
@section('page-description', 'Visualize o faturamento de todas as empresas em um período específico')

@section('content')
<div class="p-6">
    <!-- Date Filter -->
    <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('admin.billing-period.index') }}" class="flex flex-wrap gap-4">
    ...
    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                        ...
                        <tr class="hover:bg-gray-50/50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.billing-period.show', ['user' => $company->id, 'date_from' => $startDate->format('Y-m-d'), 'date_to' => $endDate->format('Y-m-d')]) }}" class="text-blue-600 hover:text-blue-700 text-sm">
                                        Ver detalhes
                                    </a>
        ...
        @if($companies->hasPages())
            <div class="px-6 py-3 border-t border-gray-200">
                {{ $companies->appends(['date_from' => $startDate->format('Y-m-d'), 'date_to' => $endDate->format('Y-m-d')])->links() }}
            </div>
        @endif
    </div>
</div>
