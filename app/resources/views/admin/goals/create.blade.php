...
@section('page-title', 'Criar Nova Meta')
@section('page-description', 'Defina uma nova meta pessoal para um usuário')
...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white rounded-xl border-2 border-gray-200 overflow-hidden shadow-sm">
        <form action="{{ route('admin.goals.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                >
                    <option value="global" {{ old('user_id') === 'global' || old('user_id') === null ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select 
                    ...
                    name="period"
                    required
                    x-data="{ period: '{{ old('period', 'monthly') }}' }"
                    x-model="period"
                    class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                >
            ...
            <div x-data="{ period: '{{ old('period', 'monthly') }}' }" x-show="document.getElementById('period').value === 'custom'">
            ...
            <div class="border-t border-gray-200 pt-6 mt-6">
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <option value="cash" {{ old('reward_type') == 'cash' ? 'selected' : '' }}>Dinheiro (R$)</option>
                        <option value="bonus" {{ old('reward_type') == 'bonus' ? 'selected' : '' }}>Bônus</option>
                        <option value="discount" {{ old('reward_type') == 'discount' ? 'selected' : '' }}>Desconto</option>
                        <option value="custom" {{ old('reward_type') == 'custom' ? 'selected' : '' }}>Personalizado</option>
                    </select>
                    @error('reward_type')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    >{{ old('reward_description') }}</textarea>
