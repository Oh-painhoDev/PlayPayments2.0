        ...
        <div class="flex flex-col gap-4">
            <div class="flex justify-between items-start">
                <div class="flex flex-col gap-[7px]">
                    ...
                    <span class="text-[10px] font-bold text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded inline-block w-fit uppercase tracking-widest">Saldo: R$ {{ number_format($pixBalance ?? 0, 2, ',', '.') }}</span>
                </div>
