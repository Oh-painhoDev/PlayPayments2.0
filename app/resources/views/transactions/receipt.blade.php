...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            @php
                $streetName = is_array($customerAddress) ? ($customerAddress['street'] ?? $customerAddress['street_name'] ?? $customerAddress['streetName'] ?? null) : null;
                $streetNumber = is_array($customerAddress) ? ($customerAddress['number'] ?? $customerAddress['streetNumber'] ?? $customerAddress['street_number'] ?? null) : null;
                $neighborhood = is_array($customerAddress) ? ($customerAddress['neighborhood'] ?? $customerAddress['district'] ?? null) : null;
                $zipValue = is_array($customerAddress) ? ($customerAddress['zipcode'] ?? $customerAddress['zip_code'] ?? $customerAddress['zipCode'] ?? $customerAddress['postalCode'] ?? null) : null;
            @endphp
            @if($customerAddress && !empty($streetName))
            <div class="row">
                <div class="label">Endereço</div>
                <div class="value">{{ trim(($streetName ?? '') . ', ' . ($streetNumber ?? ''), ', ') }}</div>
            </div>
