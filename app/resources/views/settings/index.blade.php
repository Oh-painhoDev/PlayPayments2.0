                        ...
                        <div class="overflow-x-auto">
                            <div class="px-3 sm:px-4 lg:px-6 min-w-max">
                                <div class="flex gap-1 p-1 rounded-lg w-[223px] bg-[#161616]">
                                    <button onclick="switchTab('profile')" id="tab-profile" class="flex items-center gap-2 px-4 py-2 rounded-md text-[12px] font-semibold tracking-[-0.24px] transition-colors whitespace-nowrap bg-[#1F1F1F] text-[#D4AF37]">
                                                ...
                                                <div class="relative">
                                                    <div class="w-20 h-20 rounded-full overflow-hidden bg-[#1F1F1F] flex items-center justify-center">
                                                        ...
                                                        @if($hasPhoto && $photoUrl)
                                                            <img src="{{ $photoUrl }}" alt="Foto de perfil" class="w-full h-full object-cover" id="user-photo-img">
                                                        @else
                                                            <div class="w-full h-full flex items-center justify-center bg-[#D4AF37] text-white text-lg font-semibold" id="user-photo-placeholder">
                                            ...
                                            <div class="grid gap-4 grid-cols-1">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="fantasy_name" name="fantasy_name" value="{{ old('fantasy_name', $user->fantasy_name) }}" style="padding-left: 2.2rem;" placeholder="Digite o nome fantasia">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="email" name="email" type="email" value="{{ old('email', $user->email) }}" style="padding-left: 2.2rem;" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="phone" value="{{ $user->formatted_whatsapp ?? $user->whatsapp ?? '' }}" style="padding-left: 2.2rem;" readonly disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex flex-col justify-between">
                                                    ...
                                                    <div class="flex items-center gap-3 mt-4 lg:mt-0">
                                                        <div class="w-[70px] h-[70px] rounded-full flex items-center justify-center bg-[#1F1F1F]">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-building2 lucide-building-2 h-10 w-10" style="color: rgb(33, 179, 221);">
                                                                <path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path>
                                                                <path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path>
                                                                <path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path>
                                                                <path d="M10 6h4"></path>
                                                        ...
                                                        <div class="flex flex-col gap-2">
                                                            <h3 class="text-[14px] font-semibold tracking-[-0.28px] text-white">{{ $user->name }}</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                
                                                <form action="{{ route('settings.profile.update') }}" method="POST" enctype="multipart/form-data" class="flex-1">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid gap-3 sm:gap-4 grid-cols-1 lg:grid-cols-2">
                                                        <div class="flex flex-col gap-3 sm:gap-4">
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <div class="px-4 py-3 rounded-lg bg-[#1F1F1F]">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ $user->name }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <div class="px-4 py-3 rounded-lg bg-[#1F1F1F]">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ $user->formatted_document }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <div class="px-4 py-3 rounded-lg bg-[#1F1F1F]">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ $user->formatted_cep ?? 'N/A' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <div class="px-4 py-3 rounded-lg bg-[#1F1F1F]">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ explode(',', $user->address ?? '')[1] ?? 'N/A' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                        ...
                                                        <div class="flex flex-col gap-3 sm:gap-4">
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="company_fantasy_name" name="fantasy_name" value="{{ old('fantasy_name', $user->fantasy_name) }}" placeholder="Digite o nome fantasia">
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="company_website" name="website" type="url" value="{{ old('website', $user->website) }}" placeholder="https://exemplo.com.br">
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <input class="flex w-full border py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-[42px] px-3 rounded-lg text-[12px] font-semibold tracking-[-0.24px] bg-[#1F1F1F] text-white border-[#2A2A2A] placeholder-[#AAAAAA]" id="company_address" name="address" value="{{ old('address', $user->address) }}" placeholder="Digite o endereço">
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                            ...
                                                            <div class="flex flex-col gap-2">
                                                                ...
                                                                <div class="px-4 py-3 rounded-lg bg-[#1F1F1F]">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ $user->city ?? 'N/A' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="flex flex-col gap-2">
                                                        ...
                                                        <div class="p-5">
                                                            <div class="space-y-4">
                                                                <div class="flex items-center gap-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-qr-code h-[18px] w-[18px]" style="color: rgb(33, 179, 221);">
                                                                ...
                                                                <div class="flex justify-between items-center">
                                                                    ...
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ number_format($formattedFees['pix']['percentage'], 2, ',', '.') }}% + R$ {{ number_format($formattedFees['pix']['fixed'], 2, ',', '.') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="text-card-foreground shadow-sm transition-all duration-300 rounded-[16px] h-full bg-[#1f1f1f] border-[#1f1f1f]">
                                                        <div class="p-5">
                                                            <div class="space-y-4">
                                                                <div class="flex items-center gap-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-credit-card h-[18px] w-[18px]" style="color: rgb(33, 179, 221);">
                                                                ...
                                                                <div class="flex justify-between items-center">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-[#707070]">Valor</span>
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ number_format($formattedFees['credit_card']['percentage'], 2, ',', '.') }}% + R$ {{ number_format($formattedFees['credit_card']['fixed'], 2, ',', '.') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="space-y-4">
                                                                <div class="flex items-center gap-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="h-[18px] w-[18px]">
                                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.00001 3V15H1.5V3H3.00001ZM6 3V15H4.49999V3H6ZM8.99999 3V15H7.50001V3H8.99999ZM16.5 3V15H15V3H16.5ZM11.25 3V15H10.5V3H11.25ZM13.5 3V15H12.75V3H13.5Z" fill="#D4AF37"></path>
                                                                    </svg>
                                                                    <p class="text-[12px] font-semibold tracking-[-0.24px] text-[#707070]">Método de pagamento instantâneo</p>
                                                                </div>
                                                                <div class="h-px w-full opacity-20 bg-[#707070]"></div>
                                                                ...
                                                                <div class="flex justify-between items-center">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-[#707070]">Valor</span>
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ number_format($formattedFees['bank_slip']['percentage'], 2, ',', '.') }}% + R$ {{ number_format($formattedFees['bank_slip']['fixed'], 2, ',', '.') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="text-card-foreground shadow-sm transition-all duration-300 rounded-[16px] h-full bg-[#1f1f1f] border-[#1f1f1f]">
                                                        <div class="p-5">
                                                            <div class="space-y-4">
                                                                <div class="flex items-center gap-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet h-[18px] w-[18px]" style="color: rgb(33, 179, 221);">
                                                                ...
                                                                <div class="flex justify-between items-center">
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-[#707070]">Valor</span>
                                                                    <span class="text-[12px] font-semibold tracking-[-0.24px] text-white">{{ number_format($formattedFees['withdrawal']['percentage'], 2, ',', '.') }}% + R$ {{ number_format($formattedFees['withdrawal']['fixed'], 2, ',', '.') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
function switchTab(tab) {
    ...
    document.getElementById('tab-profile').classList.remove('bg-[#1F1F1F]', 'text-[#D4AF37]');
    document.getElementById('tab-profile').classList.add('text-[#707070]');
    document.getElementById('tab-fees').classList.remove('bg-[#1F1F1F]', 'text-[#D4AF37]');
    ...
    if (tab === 'profile') {
        ...
        document.getElementById('tab-profile').classList.add('bg-[#1F1F1F]', 'text-[#D4AF37]');
        ...
        document.getElementById('tab-fees').classList.add('bg-[#1F1F1F]', 'text-[#D4AF37]');
...
function handlePhotoUpload(event) {
    ...
    if (!validTypes.includes(file.type)) {
        console.error('Formato de arquivo inválido. Use JPG, PNG, GIF ou WebP.');
        event.target.value = '';
        return;
    }
    ...
    // Show loading state
    const photoContainer = event.target.closest('.relative').querySelector('.w-20');
    const originalContent = photoContainer.innerHTML;
    photoContainer.innerHTML = '<div class="w-full h-full flex items-center justify-center bg-[#1F1F1F]"><div class="animate-spin rounded-full h-8 w-8 border-b-2 border-white"></div></div>';
    
    // Use the photo update route
    ...
    .then(async response => {
        ...
        if (!response.ok || !data.success) {
            ...
            } else if (data.errors && data.errors.photo) {
                errorMessage = 'Erro: ' + (Array.isArray(data.errors.photo) ? data.errors.photo.join(', ') : data.errors.photo);
            } else if (data.error) {
    ...
    .then(data => {
        ...
        if (data.photo_url) {
            if (photoImg) {
                ...
                photoImg.src = data.photo_url + '?t=' + Date.now();
            } else if (photoPlaceholder) {
                // Replace placeholder with image
                photoPlaceholder.remove();
                photoContainer.innerHTML = `<img src="${data.photo_url}?t=${Date.now()}" alt="Foto de perfil" class="w-full h-full object-cover" id="user-photo-img">`;
            } else if (photoContainer) {
                // Create img element if container exists
                photoContainer.innerHTML = `<img src="${data.photo_url}?t=${Date.now()}" alt="Foto de perfil" class="w-full h-full object-cover" id="user-photo-img">`;
            }
        }
        ...
        if (sidebarPhoto && data.photo_url) {
            sidebarPhoto.src = data.photo_url + '?t=' + Date.now();
        }
        
        // Success - no alert needed, photo is already updated visually
    })
    .catch(error => {
        ...
        console.error('Erro ao atualizar foto: ' + (error.message || 'Tente novamente.'));
    })
    .finally(() => {
        // Reset input
        event.target.value = '';
