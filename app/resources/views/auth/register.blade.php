        ...
        <div class="login-form">
            <div class="card-header" style="justify-content: center; border-bottom: none; margin-bottom: 2rem;">
                <a href="{{ url('/') }}" class="logo-link">
                    <img src="{{ asset('images/playpayments-logo-top.webp') }}" alt="PlayPayments" class="logo-img">
                </a>
            </div>
            ...
            <form action="{{ request()->is('cadastro*') ? route('cadastro.post') : route('register.post') }}" method="POST" id="registerForm">
                ...
                <div class="login-form-items">
                    <div class="items">
                        ...
                        <div class="input">
                            <input type="text" id="reg-name" name="name" placeholder="Seu nome" value="{{ old('name') }}" required class="cyber-input">
                            <i class="ri-user-line"></i>
                        </div>
                        @error('name') <small style="color: #ef5350; font-family: var(--font-code); font-size: 0.7rem; margin-top: 4px;">{{ $message }}</small> @enderror
                    </div>

                    <div class="items">
                        <label for="reg-email">E-mail</label>
                        <div class="input">
                            <input type="email" id="reg-email" name="email" placeholder="seu@email.com" value="{{ old('email') }}" required class="cyber-input">
                            <i class="ri-mail-line"></i>
                        </div>
                        @error('email') <small style="color: #ef5350; font-family: var(--font-code); font-size: 0.7rem; margin-top: 4px;">{{ $message }}</small> @enderror
                    </div>

                    <div class="items">
                        <label for="reg-whatsapp">WhatsApp</label>
                        <div class="input">
                            <input type="text" id="reg-whatsapp" name="whatsapp" placeholder="(00) 00000-0000" value="{{ old('whatsapp') }}" required class="cyber-input">
                            <i class="ri-whatsapp-line"></i>
                        </div>
                        @error('whatsapp') <small style="color: #ef5350; font-family: var(--font-code); font-size: 0.7rem; margin-top: 4px;">{{ $message }}</small> @enderror
                    </div>
                    ...
                    <div class="items">
                        ...
                        @error('password') <small style="color: #ef5350; font-family: var(--font-code); font-size: 0.7rem; margin-top: 4px;">{{ $message }}</small> @enderror
                    </div>
                    ...
                    <a href="{{ route('login') }}" class="cyber-btn" style="background: transparent; border: 1px solid #fff; box-shadow: none;">Já tenho conta</a>
                </div>
            </form>
        </div>
    </div>
