...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $getWhiteLabelImageUrl = function($key) {
            ...
            $setting = \Illuminate\Support\Facades\DB::table('white_label_settings')
                ->where('key', $key)
                ->first();
        ...
        View::composer('*', function ($view) use ($getWhiteLabelImageUrl) {
            $themeVars = [
            ...
            // Get white label favicon and banner
            ...
            $seoMeta = [
                ...
                'keywords' => 'playpayments, playpayments, playpayments pay, gateway pagamento, pagamento pix, pix gateway, gateway de pagamento brasil, api pix, integração pix, pagamentos online, gateway pagamentos, playpayments.com, pagamento online pix, api de pagamento, gateway pagamento online, pagamento instantâneo, recebimento pix, sistema pagamento pix, integração pagamento pix',
                'author' => 'playpayments',
