<?php $__env->startSection('title', 'Criar Meta'); ?>
<?php $__env->startSection('page-title', 'Criar Nova Meta'); ?>
<?php $__env->startSection('page-description', 'Defina uma nova meta pessoal para um usuário'); ?>
...
<div class="p-6 space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 rounded-2xl p-8 text-white shadow-xl">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">➕ Criar Nova Meta</h1>
                <p class="text-purple-100">Defina uma nova meta pessoal de faturamento, vendas ou outras métricas</p>
            </div>
            <a href="<?php echo e(route('admin.goals.index')); ?>" class="bg-white hover:bg-gray-100 text-purple-700 px-6 py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl flex items-center">
    ...
    <div class="bg-white rounded-xl border-2 border-gray-200 overflow-hidden shadow-sm">
        <form action="<?php echo e(route('admin.goals.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                >
                    <option value="global" <?php echo e(old('user_id') === 'global' || old('user_id') === null ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-500">Tipo da meta: faturamento (valor), vendas (valor), transações (quantidade), pedidos (quantidade), clientes (quantidade)</p>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input 
                    ...
                    id="target_value" 
                    name="target_value" 
                    value="<?php echo e(old('target_value')); ?>"
                    step="0.01"
                    min="0"
                    required
                    class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select 
                    ...
                    name="period"
                    required
                    x-data="{ period: '<?php echo e(old('period', 'monthly')); ?>' }"
                    x-model="period"
                    class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                >
...
unset($__errorArgs, $__bag); ?>
            ...
            <div x-data="{ period: '<?php echo e(old('period', 'monthly')); ?>' }" x-show="document.getElementById('period').value === 'custom'">
            ...
            <div class="border-t border-gray-200 pt-6 mt-6">
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <option value="cash" <?php echo e(old('reward_type') == 'cash' ? 'selected' : ''); ?>>Dinheiro (R$)</option>
                        <option value="bonus" <?php echo e(old('reward_type') == 'bonus' ? 'selected' : ''); ?>>Bônus</option>
                        <option value="discount" <?php echo e(old('reward_type') == 'discount' ? 'selected' : ''); ?>>Desconto</option>
                        <option value="custom" <?php echo e(old('reward_type') == 'custom' ? 'selected' : ''); ?>>Personalizado</option>
                    </select>
                    <?php $__errorArgs = ['reward_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        id="reward_value" 
                        name="reward_value" 
                        value="<?php echo e(old('reward_value')); ?>"
                        step="0.01"
                        min="0"
                        class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                        placeholder="100.00"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    ><?php echo e(old('reward_description')); ?></textarea>
                    <?php $__errorArgs = ['reward_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center mb-4">
                    <input 
                        ...
                        name="auto_reward" 
                        value="1"
                        <?php echo e(old('auto_reward') ? 'checked' : ''); ?>
            ...
            <div class="flex justify-end gap-4 pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('admin.goals.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-3 rounded-xl font-semibold transition-all">
                    Cancelar
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u999974013/domains/playpayments.com/public_html/resources/views/admin/goals/create.blade.php ENDPATH**/ ?>