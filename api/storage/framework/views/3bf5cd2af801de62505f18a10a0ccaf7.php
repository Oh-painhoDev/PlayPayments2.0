...
<head>
    ...
    <title><?php echo e(config('app.name', 'PixBolt')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <style>
        ...
        .sidebar-container nav a .absolute.bg-\\[\\#21b3dd\\] {
            left: -20px !important;
            z-index: 10;
        }
    ...
    <link rel="stylesheet" href="/css/instant-transitions.css">
    ...
    <!-- Instant Navigation -->
    <script src="/js/instant-navigation.js" defer></script>
...
<body class="font-sans antialiased text-white" style="background-color: #000000;" x-data="{ sidebarOpen: false, sidebarCollapsed: false }">
    <div class="dashboard-wrapper flex h-screen w-full overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside x-bind:class="{ 'open': sidebarOpen }" class="sidebar-container flex flex-col transition-all duration-300 ease-in-out top-0 left-0 z-50 relative mt-5 ml-5 mb-5 rounded-t-[20px] w-[266px] bg-[#161616]">
            <div class="flex flex-col h-full pt-10 pb-5">
                <div class="px-5 mb-6 relative flex-shrink-0">
                    <div class="flex items-center justify-center mb-4 relative">
                        <img alt="<?php echo e(config('app.name')); ?>" loading="lazy" width="110" height="27" decoding="async" data-nimg="1" class="h-[26.795px] w-[110px]" src="/images/playpayments-logo-top.webp" style="color: transparent;">
                    ...
                    <!-- Botões de Navegação Rápida por Categorias -->
                    <div class="flex flex-wrap gap-1.5">
                        <button onclick="scrollToSection('section-principal')" class="px-2.5 py-1.5 text-xs font-semibold tracking-[-0.24px] rounded-[6px] bg-[#1E1E1E] text-[#6B7280] hover:bg-[#2a2a2a] hover:text-white transition-all duration-200" style="font-family: Manrope, sans-serif;">
                            Principal
                        </button>
                        <?php if (\Illuminate\Support\Facades\Blade::check('documentsApproved')): ?>
                        <button onclick="scrollToSection('section-financeiro')" class="px-2.5 py-1.5 text-xs font-semibold tracking-[-0.24px] rounded-[6px] bg-[#1E1E1E] text-[#6B7280] hover:bg-[#2a2a2a] hover:text-white transition-all duration-200" style="font-family: Manrope, sans-serif;">
                            Financeiro
                        </button>
                        <button onclick="scrollToSection('section-gestao')" class="px-2.5 py-1.5 text-xs font-semibold tracking-[-0.24px] rounded-[6px] bg-[#1E1E1E] text-[#6B7280] hover:bg-[#2a2a2a] hover:text-white transition-all duration-200" style="font-family: Manrope, sans-serif;">
                            Gestão
                        </button>
                        <button onclick="scrollToSection('section-integracoes')" class="px-2.5 py-1.5 text-xs font-semibold tracking-[-0.24px] rounded-[6px] bg-[#1E1E1E] text-[#6B7280] hover:bg-[#2a2a2a] hover:text-white transition-all duration-200" style="font-family: Manrope, sans-serif;">
                            Integrações
                        </button>
                        <?php endif; ?>
                        <button onclick="scrollToSection('section-sistema')" class="px-2.5 py-1.5 text-xs font-semibold tracking-[-0.24px] rounded-[6px] bg-[#1E1E1E] text-[#6B7280] hover:bg-[#2a2a2a] hover:text-white transition-all duration-200" style="font-family: Manrope, sans-serif;">
                            Sistema
                        </button>
                    </div>
                </div>
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('dashboard') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('dashboard')); ?>">
                                        ...
                                        <div class="absolute top-1/2 transform -translate-y-1/2 bg-[#21b3dd] w-1.5 h-[26px] rounded-br-[4px] rounded-tr-[4px]" style="left: -20px;"></div>
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('dashboard') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('wallet.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('wallet.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('wallet.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('transactions.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('transactions.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('transactions.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('refunds.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('refunds.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('refunds.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('revenues.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('revenues.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('revenues.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('customers.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('customers.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('customers.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('payment-links.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('payment-links.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('payment-links.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                                    ...
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 text-[#6B7280] cursor-not-allowed" href="#" onclick="return false;">
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 text-[#6B7280]">
                                                <g fill="none" fill-rule="evenodd">
                                                    <path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"></path>
                                                    <path fill="currentColor" d="M9 2a4 4 0 0 1 3 1.354A4 4 0 0 1 15 2h.5A1.5 1.5 0 0 1 17 3.5V4c0 .729-.195 1.412-.535 2H19a2 2 0 0 1 2 2v3a2 2 0 0 1-1 1.732V18a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-5.268A2 2 0 0 1 3 11V8a2 2 0 0 1 2-2h2.535A4 4 0 0 1 7 4v-.5A1.5 1.5 0 0 1 8.5 2zm9 11h-5v6h4l.117-.007a1 1 0 0 0 .876-.876L18 18zm-7 0H6v5a1 1 0 0 0 .883.993L7 19h4zm8-5h-6v3h6zm-8 0H5v3h6zM9 4a2 2 0 0 0 2 2a2 2 0 0 0-2-2m6 0a2 2 0 0 0-2 2a2 2 0 0 0 2-2"></path>
                                                </g>
                                            </svg>
                                            <div class="flex items-center gap-2 whitespace-nowrap min-w-0">
                                                <span class="text-sm font-semibold tracking-[-0.28px] text-[#6B7280]" style="font-family: Manrope, sans-serif;">Indique e Conquiste</span>
                                                <span class="px-1.5 py-0.5 text-[10px] font-medium bg-[#21b3dd] text-white rounded-full">Em Breve</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('integracoes') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('integracoes')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('integracoes') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('api-key') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('api-key')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('api-key') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('webhooks.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('webhooks.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('webhooks.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    ...
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e($isSettingsActive ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('settings.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e($isSettingsActive ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 <?php echo e(request()->routeIs('documents.*') ? 'text-white' : 'text-[#6B7280]'); ?>" href="<?php echo e(route('documents.index')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 <?php echo e(request()->routeIs('documents.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]'); ?>">
                    ...
                    <div class="flex flex-col gap-5 p-4 rounded-[6px] bg-[#1f1f1f]">
                        <div class="flex items-center gap-3">
                            <div class="relative w-9 h-9 rounded-full overflow-hidden flex-shrink-0">
                                ...
                                ?>
                                <?php if($hasPhoto): ?>
                                    <img src="<?php echo e(asset('storage/' . $user->photo)); ?>" alt="<?php echo e($user->name); ?>" class="w-full h-full object-cover sidebar-user-photo">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center bg-[#21b3dd] text-white text-xs font-semibold">
                        ...
                        <?php if(isset($goals) && $goals->count() > 0): ?>
                            ...
                            <?php if($currentGoal): ?>
                                ...
                                <div class="flex items-center gap-3 px-4 py-3 rounded-lg h-16" style="align-self: center; background: transparent;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trophy h-5 w-5 text-[#21b3dd] flex-shrink-0">
                                    ...
                                    <div class="flex flex-col gap-1.5 justify-center min-w-[120px] sm:min-w-[210px]">
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="flex-1 rounded-[40px] p-[2px] bg-[#161616]">
                                                <div class="bg-[#21b3dd] h-[6px] rounded-[40px] transition-all duration-500" style="width: <?php echo e(min(100, $currentGoal['percentage'])); ?>%;"></div>
                                            </div>
                        ...
                        <?php if(isset($goals) && $goals->count() > 0): ?>
                            ...
                            <?php if($currentGoal): ?>
                                <div class="flex items-center gap-2 px-3 py-2 rounded-lg flex-1" style="background: transparent;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trophy h-4 w-4 text-[#21b3dd] flex-shrink-0">
                                        <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path>
                                        <path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path>
                                        <path d="M4 22h16"></path>
                                        <path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"></path>
                                    ...
                                    <div class="flex flex-col gap-1 justify-center flex-1 min-w-0">
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="flex-1 rounded-[40px] p-[2px] bg-[#161616]">
                                                <div class="bg-[#21b3dd] h-[4px] rounded-[40px] transition-all duration-500" style="width: <?php echo e(min(100, $currentGoal['percentage'])); ?>%;"></div>
                                            </div>
...
</html><?php /**PATH /home/u999974013/domains/playpayments.com/public_html/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>