                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs font-semibold text-[#707070]"><?php echo e($transaction->customer_data['document'] ?? 'N/A'); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/transactions/show.blade.php ENDPATH**/ ?>