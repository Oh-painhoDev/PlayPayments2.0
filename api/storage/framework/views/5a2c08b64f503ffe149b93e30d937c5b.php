<?php $__env->startSection('title', 'Vendas Retidas'); ?>
<?php $__env->startSection('page-title', 'Vendas Retidas'); ?>
<?php $__env->startSection('page-description', 'Visualize todas as transações retidas pelo sistema'); ?>
...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p class="text-lg font-bold text-gray-900"><?php echo e(number_format($totalRetained)); ?></p>
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p class="text-lg font-bold text-gray-900">R$ <?php echo e(number_format($totalRetainedAmount, 2, ',', '.')); ?></p>
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p class="text-lg font-bold text-green-600">R$ <?php echo e(number_format($totalRefundedAmount, 2, ',', '.')); ?></p>
            <p class="text-xs text-gray-600"><?php echo e(number_format($totalRefunded)); ?> Reembolsos</p>
        </div>
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p class="text-lg font-bold text-purple-400">R$ <?php echo e(number_format($totalGatewayFees, 2, ',', '.')); ?></p>
    ...
    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $retainedSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <?php if($transaction->status === 'refunded' || $transaction->status === 'partially_refunded' || $transaction->status === 'chargeback'): ?>
                                <span class="px-2 py-1 text-xs rounded bg-green-500/20 text-green-600 border-green-500/30 ml-1">
                                    <?php echo e($transaction->status === 'refunded' ? 'Reembolsado' : ($transaction->status === 'partially_refunded' ? 'Reemb. Parcial' : 'Chargeback')); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="<?php echo e(route('admin.setup.retained-sales.return', $transaction->transaction_id)); ?>" method="POST" class="inline" onsubmit="return confirm('Tem certeza que deseja devolver esta venda para o usuário? Isso irá liberar o valor para a carteira do usuário e enviar uma notificação de pagamento.');">
                                        <?php echo csrf_field(); ?>
        ...
        <!-- Pagination -->
        <?php if($retainedSales->hasPages()): ?>
            <div class="px-6 py-3 border-t border-gray-200">
                <?php echo e($retainedSales->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs1 gateway\resources\views/admin/setup/retained-sales.blade.php ENDPATH**/ ?>