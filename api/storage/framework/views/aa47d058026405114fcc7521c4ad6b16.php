<?php $__env->startSection('title', 'Detalhes da Venda'); ?>
<?php $__env->startSection('page-title', 'Detalhes do Pedido'); ?>
<?php $__env->startSection('page-description', 'Comprovante e informações da transação'); ?>

<?php $__env->startSection('content'); ?>
<div class="container mx-auto px-4 py-6">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('transactions.index')); ?>" class="inline-flex items-center text-gray-600 hover:text-gray-900 transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center text-white">
                            ...
                            <span class="font-semibold"><?php echo e($config['label']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-8 border-b border-gray-200">
                    <div class="text-center">
                        ...
                        <div class="text-4xl font-bold text-gray-900"><?php echo e($transaction->formatted_amount); ?></div>
                    </div>
                </div>
                ...
                <div class="px-6 py-6 bg-gray-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-white rounded-lg p-4">
                            ...
                            <div class="text-sm font-mono font-semibold text-gray-900"><?php echo e($transaction->external_id ?: $transaction->transaction_id); ?></div>
                        </div>
                        
                        <div class="bg-white rounded-lg p-4">
                            <div class="text-sm text-gray-600 mb-1">Método de Pagamento</div>
                            <div class="text-sm font-semibold text-gray-900"><?php echo e(strtoupper($transaction->payment_method)); ?></div>
                        </div>
                        
                        <div class="bg-white rounded-lg p-4">
                            <div class="text-sm text-gray-600 mb-1">Taxa de Intermediação</div>
                            <div class="text-sm font-semibold text-gray-900"><?php echo e($transaction->formatted_fee_amount); ?></div>
                        </div>
                        
                        <div class="bg-white rounded-lg p-4">
                            <div class="text-sm text-gray-600 mb-1">Valor Líquido</div>
                            <div class="text-sm font-semibold text-green-600"><?php echo e($transaction->formatted_net_amount); ?></div>
                        </div>
                        
                        <div class="bg-white rounded-lg p-4">
                            <div class="text-sm text-gray-600 mb-1">Data de Criação</div>
                            <div class="text-sm font-semibold text-gray-900"><?php echo e($transaction->created_at->format('d/m/Y H:i')); ?></div>
                        </div>
                        
                        <?php if($transaction->expires_at): ?>
                        <div class="bg-white rounded-lg p-4">
                            <div class="text-sm text-gray-600 mb-1">Vencimento</div>
                            <div class="text-sm font-semibold text-gray-900"><?php echo e($transaction->expires_at->format('d/m/Y H:i')); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="px-6 py-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm font-semibold text-gray-900 flex-1"><?php echo e($transaction->customer_data['name'] ?? 'N/A'); ?></div>
                        </div>
                        
                        <div class="flex items-start">
                            <div class="text-sm text-gray-600 w-24">E-mail:</div>
                            <div class="text-sm font-semibold text-gray-900 flex-1"><?php echo e($transaction->customer_data['email'] ?? 'N/A'); ?></div>
                        </div>
                        
                        <div class="flex items-start">
                            <div class="text-sm text-gray-600 w-24">CPF/CNPJ:</div>
                            <div class="text-sm font-semibold text-gray-900 flex-1"><?php echo e($transaction->customer_data['document'] ?? 'N/A'); ?></div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-sm font-semibold text-gray-900 flex-1"><?php echo e($transaction->customer_data['phone']); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center pb-3 border-b border-gray-200">
                        <div>
                            <div class="text-sm font-medium text-gray-900">
                                <?php echo e($transaction->metadata['description'] ?? 'Produto/Serviço'); ?>
                    ...
                    <div class="flex justify-between text-lg font-bold text-gray-900 pt-2">
                        <span>Total:</span>
                        <span class="text-green-600"><?php echo e($transaction->formatted_amount); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-md p-6 border-2 border-green-200">
                ...
                <div class="text-3xl font-bold text-green-600"><?php echo e(auth()->user()->formatted_wallet_balance); ?></div>
            </div>
        </div>
    </div>
</div>
...
<div id="pixModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4" onclick="if(event.target === this) closePixModal()">
    <div class="bg-white rounded-2xl max-w-lg w-full shadow-2xl" onclick="event.stopPropagation()">
        ...
        <div class="p-6 space-y-6">
            <!-- QR Code -->
            <?php if($pixEncodedImage && !empty($pixEncodedImage)): ?>
            <div class="text-center">
            ...
            <?php elseif($pixQrCodeUrl && !empty($pixQrCodeUrl)): ?>
            <div class="text-center">
                <div class="text-sm font-semibold text-gray-900 mb-3">Escaneie o QR Code</div>
                <div class="flex justify-center bg-white p-4 rounded-lg border-2 border-gray-200">
                    <img src="<?php echo e($pixQrCodeUrl); ?>" 
                         alt="QR Code PIX" 
            ...
            <div>
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button 
                        onclick="copyPixCode('<?php echo e($pixPayload); ?>')"
                        id="copyPixBtn"
...
<?php if(($transaction->status === 'pending' && !$transaction->is_retained) || ($transaction->is_retained)): ?>
    setInterval(() => {
        location.reload();
    }, 30000);
<?php endif; ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/sales/show.blade.php ENDPATH**/ ?>