<?php $__env->startSection('title', 'Detalhes de Faturamento'); ?>
<?php $__env->startSection('page-title', 'Faturamento: ' . $user->name); ?>
<?php $__env->startSection('page-description', 'Detalhes completos de faturamento e saques da empresa'); ?>
...
<div class="p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center space-x-4 mt-2">
                    ...
                    <span class="text-gray-600 text-sm"><?php echo e($user->formatted_document); ?></span>
                    <span class="text-gray-600 text-sm">Membro desde <?php echo e($user->created_at ? $user->created_at->format('d/m/Y') : 'N/A'); ?></span>
                </div>
            </div>
            <div class="flex space-x-3">
                ...
                <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="bg-blue-600 hover:bg-blue-700 text-gray-900 px-4 py-2 rounded-lg text-sm">
                    Ver Perfil
                </a>
                <a href="<?php echo e(route('admin.billing.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm">
                    Voltar
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-300">
            ...
            <p class="text-xs text-gray-600"><?php echo e(number_format($totals['total_withdrawals'])); ?> Saques Concluídos</p>
        </div>
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-300">
            ...
            <p class="text-lg font-bold text-gray-900">R$ <?php echo e(number_format($totals['net_balance'], 2, ',', '.')); ?></p>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div>
                                            <p class="text-gray-900 font-medium"><?php echo e($transaction->customer_data['name'] ?? 'N/A'); ?></p>
                                            <p class="text-gray-600 text-sm"><?php echo e($transaction->customer_data['email'] ?? 'N/A'); ?></p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="<?php echo e(route('admin.transactions.show', $transaction->transaction_id)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                            Ver
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-gray-900 font-medium"><?php echo e($withdrawal->formatted_amount); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-gray-600 text-sm"><?php echo e($withdrawal->formatted_fee); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-gray-900 text-sm"><?php echo e($withdrawal->pix_type_label); ?></div>
                                        <div class="text-gray-600 text-xs"><?php echo e(Str::mask($withdrawal->pix_key, '*', 4)); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="<?php echo e(route('admin.withdrawals.show', $withdrawal)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                            Ver
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admin/billing/show.blade.php ENDPATH**/ ?>