<?php $__env->startSection('title', 'Solicitar Saque'); ?>
<?php $__env->startSection('page-title', 'Solicitar Saque'); ?>
<?php $__env->startSection('page-description', 'Transfira seu saldo para sua conta bancária via PIX'); ?>
...
<div class="p-6 space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 rounded-2xl p-8 text-white shadow-xl">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                ...
                <p class="text-3xl font-bold"><?php echo e($user->formatted_wallet_balance); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            <form action="<?php echo e(route('wallet.store')); ?>" method="POST" id="withdrawalForm">
                <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    type="number" 
                                    step="0.01"
                                    min="<?php echo e($fee + 0.01); ?>"
                                    max="<?php echo e($user->wallet_balance); ?>"
                                    required 
                                    value="<?php echo e(old('amount', $user->wallet_balance)); ?>"
                            ...
                            <p class="text-xs text-gray-500 mt-2">Valor mínimo: R$ <?php echo e(number_format($fee + 0.01, 2, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="cpf" <?php echo e(old('pix_type') == 'cpf' ? 'selected' : ''); ?>>CPF</option>
                                <option value="email" <?php echo e(old('pix_type') == 'email' ? 'selected' : ''); ?>>E-mail</option>
                                <option value="phone" <?php echo e(old('pix_type') == 'phone' ? 'selected' : ''); ?>>Telefone</option>
                                <option value="random" <?php echo e(old('pix_type') == 'random' ? 'selected' : ''); ?>>Chave Aleatória</option>
                            </select>
                        </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="<?php echo e(route('wallet.index')); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-semibold transition-all">
                        Cancelar
                    </a>
                    <button 
                        type="submit" 
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between p-3 bg-white rounded-xl">
                        ...
                        <span class="text-gray-900 font-bold"><?php echo e($user->formatted_wallet_balance); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between p-3 bg-white rounded-xl">
                        ...
                        <span class="text-orange-600 font-bold" id="summary_fee">R$ <?php echo e(number_format($fee, 2, ',', '.')); ?></span>
                    </div>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="bg-white rounded-xl p-4">
                    <div class="flex items-center mb-3">
                        <div class="w-3 h-3 <?php echo e($user->withdrawal_type === 'automatic' ? 'bg-emerald-500' : 'bg-emerald-500'); ?> rounded-full mr-3 animate-pulse"></div>
                        <span class="text-gray-900 font-bold"><?php echo e($user->withdrawal_type === 'automatic' ? 'Automático' : 'Manual'); ?></span>
                    </div>
                    
                    <p class="text-gray-600 text-sm">
                        <?php if($user->withdrawal_type === 'automatic'): ?>
                    ...
                    <div class="bg-white rounded-xl p-3 flex items-start">
                        ...
                        <p class="text-gray-700 text-sm">
                            <?php if($feeData['type'] === 'percentage'): ?>
                                A taxa de saque é de <?php echo e($feeData['percentage_fee']); ?>% do valor solicitado.
                            <?php elseif($feeData['type'] === 'fixed'): ?>
                                A taxa de saque é fixa de R$ <?php echo e(number_format($feeData['fixed_fee'], 2, ',', '.')); ?> por operação.
                            <?php elseif($feeData['type'] === 'both'): ?>
                                A taxa de saque é de R$ <?php echo e(number_format($feeData['fixed_fee'], 2, ',', '.')); ?> + <?php echo e($feeData['percentage_fee']); ?>% do valor.
                            <?php else: ?>
                                A taxa de saque é de R$ <?php echo e(number_format($fee, 2, ',', '.')); ?> por operação.
                            <?php endif; ?>
                        </p>
                    </div>
...
$(document).ready(function() {
    const feeData = <?php echo json_encode($feeData, 15, 512) ?>;
    const maxAmount = <?php echo e($user->wallet_balance); ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/withdrawals/create.blade.php ENDPATH**/ ?>