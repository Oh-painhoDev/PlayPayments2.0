    ...
    <section class="bg-billing-chart">
        ...
        <section class="billing-cards">
            ...
            <div class="card">
                ...
                <div class="data">
                    ...
                    <p>R$ <?php echo e(number_format($netValue ?? 0, 2, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="data">
                    ...
                    <p>R$ <?php echo e(number_format($totalSales ?? 0, 2, ',', '.')); ?></p>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="data">
                    ...
                    <p>R$ <?php echo e(number_format($pendingSales ?? 0, 2, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="data">
                    ...
                    <p>R$ <?php echo e(number_format($averageTicket ?? 0, 2, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="data">
                    ...
                    <p><?php echo e($paidTransactions ?? 0); ?></p>
        </div>
    </div>
        </section>
        ...
        <section class="billing-cards-secondary">
            <div class="grid">
                ...
                <a href="<?php echo e(route('api-key')); ?>">
                    <div>
                        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="bg-billing-data">
        ...
        <div class="billing-data-card">
            ...
            <div class="top">
                ...
                <h2>R$ <?php echo e(number_format($pendingSales ?? 0, 2, ',', '.')); ?></h2>
            </div>
            <div class="divider-line"></div>
            <div class="bottom">
                <p><?php echo e(\App\Models\Transaction::where('user_id', Auth::id())->whereIn('status', ['pending', 'waiting_payment'])->count()); ?> cobranças</p>
                <p class="percents"><?php echo e(number_format(($pendingSales ?? 0) > 0 && ($totalSales ?? 0) > 0 ? (($pendingSales / ($totalSales + $pendingSales)) * 100) : 0, 2, ',', '.')); ?>%</p>
            </div>
        </div>
        ...
        <div class="billing-data-card">
            ...
            <div class="top">
                ...
                <h2>R$ <?php echo e(number_format($refundedAmount ?? 0, 2, ',', '.')); ?></h2>
            </div>
            <div class="divider-line"></div>
            <div class="bottom">
                <p><?php echo e($refundedCount ?? 0); ?> cobranças</p>
                <p class="percents"><?php echo e(number_format($refundedPercentage ?? 0, 2, ',', '.')); ?>%</p>
            </div>
        </div>
        ...
        <div class="billing-data-card">
            ...
            <div class="top">
                ...
                <h2>R$ <?php echo e(number_format($chargebackAmount ?? 0, 2, ',', '.')); ?></h2>
            </div>
            <div class="divider-line"></div>
            <div class="bottom">
                <p><?php echo e($chargebackCount ?? 0); ?> cobranças</p>
                <p class="percents"><?php echo e(number_format($chargebackPercentage ?? 0, 2, ',', '.')); ?>%</p>
            </div>
        </div>
        ...
        <div class="billing-data-card">
            ...
            <div class="top">
                ...
                <h2>R$ <?php echo e(number_format($cancelledAmount ?? 0, 2, ',', '.')); ?></h2>
            </div>
            <div class="divider-line"></div>
            <div class="bottom">
                <p><?php echo e($cancelledCount ?? 0); ?> cobranças</p>
                <p class="percents"><?php echo e(number_format($cancelledPercentage ?? 0, 2, ',', '.')); ?>%</p>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u999974013/domains/playpayments.com/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>