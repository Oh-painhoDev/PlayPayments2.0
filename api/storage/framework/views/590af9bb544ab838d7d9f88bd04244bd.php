<?php $__env->startSection('title', 'Documentação - Webhooks'); ?>
<?php $__env->startSection('page-title', 'Documentação Webhooks'); ?>
<?php $__env->startSection('page-description', 'Aprenda como usar webhooks para receber notificações em tempo real'); ?>
...
<div class="container mx-auto p-8">
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="rounded-2xl p-6 bg-[#161616]">
            ...
            <div class="bg-[#1f1f1f] rounded-lg p-4 mt-4 border-l-4 border-[#21b3dd]">
                ...
                <ul class="text-[#AAAAAA] text-sm mt-2 space-y-1 list-disc list-inside ml-2">
                    <li>Quando um PIX é gerado → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.created</code></li>
                    <li>Quando um pagamento é aprovado → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.paid</code></li>
                    <li>Quando há um reembolso → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.refunded</code></li>
                    <li>Quando há chargeback → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.chargeback</code></li>
                    <li>Quando é cancelada → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.cancelled</code></li>
                    <li>Quando falha → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.failed</code></li>
                    <li>Quando expira → <code class="bg-[#161616] px-1.5 py-0.5 rounded text-[#21b3dd] text-xs">transaction.expired</code></li>
                </ul>
        ...
        <div class="rounded-2xl p-6 bg-[#161616]">
            ...
            <div class="space-y-3">
                <div class="border-l-4 border-[#21b3dd] pl-4 py-2">
      ...
      "email": "joao@exemplo.com"
        ...
        <div class="rounded-2xl p-6 bg-[#161616]">
            ...
            <p class="text-[#AAAAAA] text-sm mb-4">
                Para garantir a segurança, cada requisição inclui um header <code class="bg-[#1f1f1f] px-2 py-1 rounded text-[#21b3dd]">X-PixBolt-Signature</code> 
  ...
  if (signature === expectedSignature) {
    ...
    res.status(401).send('Unauthorized');
            ...
            <div class="bg-[#1f1f1f] rounded-lg p-4">
                <table class="w-full text-sm text-[#AAAAAA]">
                    ...
                    <tbody class="space-y-2">
                        <tr class="border-b border-[#2d2d2d]">
                            <td class="py-2"><code class="bg-[#161616] px-2 py-1 rounded text-[#21b3dd]">Content-Type</code></td>
                            <td class="py-2">application/json</td>
                        </tr>
                        <tr class="border-b border-[#2d2d2d]">
                            <td class="py-2"><code class="bg-[#161616] px-2 py-1 rounded text-[#21b3dd]">User-Agent</code></td>
                            <td class="py-2">PixBolt-Webhook/1.0</td>
                        </tr>
                        <tr>
                            <td class="py-2"><code class="bg-[#161616] px-2 py-1 rounded text-[#21b3dd]">X-PixBolt-Signature</code></td>
        ...
        <div class="rounded-2xl p-6 bg-[#161616]">
            ...
            <p class="text-[#AAAAAA] text-sm mb-4">
                Seu endpoint deve responder com status HTTP <code class="bg-[#1f1f1f] px-2 py-1 rounded text-[#21b3dd]">200 OK</code> 
    ...
    "retention_type": 2
        ...
        <div class="rounded-2xl p-6 bg-[#161616]">
            ...
            <ul class="space-y-2 text-[#AAAAAA] text-sm list-disc list-inside mb-4">
                <li><a href="https://webhook.site" target="_blank" class="text-[#21b3dd] hover:underline">webhook.site</a> - Receba webhooks temporários para teste</li>
                <li><a href="https://ngrok.com" target="_blank" class="text-[#21b3dd] hover:underline">ngrok</a> - Exponha seu servidor local para receber webhooks</li>
            </ul>
            <p class="text-[#AAAAAA] text-sm">
        ...
        <div class="flex justify-start">
            <a href="<?php echo e(route('webhooks.index')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold tracking-[-0.24px] bg-[#1f1f1f] hover:bg-[#2a2a2a] text-white rounded-lg transition-colors">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u999974013/domains/playpayments.com/public_html/resources/views/webhooks/documentation.blade.php ENDPATH**/ ?>