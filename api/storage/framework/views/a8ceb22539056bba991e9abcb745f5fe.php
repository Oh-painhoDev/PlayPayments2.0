        ...
        <div class="bg-[#000000] rounded-2xl space-y-6">
            ...
            <div class="content-stretch flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between relative size-full p-5 gap-6 md:gap-0">
                ...
                <div class="flex gap-3">
                    <a href="<?php echo e(route('revenues.export', request()->query())); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-[#21b3dd] hover:bg-[#21b3dd] text-white rounded-lg text-sm font-semibold transition-colors">
            ...
            <div class="box-border flex flex-col gap-2.5 items-start justify-start p-[20px] relative rounded-2xl shrink-0 w-full bg-[#161616]">
                <form method="GET" action="<?php echo e(route('revenues.index')); ?>" class="flex flex-col md:flex-row gap-4 w-full">
                    <div class="flex items-center gap-2">
                        <label class="text-[12px] font-semibold text-[#AAAAAA] whitespace-nowrap">Período:</label>
                        <input type="date" name="start_date" value="<?php echo e($startDate); ?>" class="px-3 py-2 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#21b3dd]">
                        <span class="text-[#AAAAAA] text-sm">até</span>
                        <input type="date" name="end_date" value="<?php echo e($endDate); ?>" class="px-3 py-2 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#21b3dd]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-5">
                <div class="p-5 rounded-2xl bg-[#161616]">
                    <div class="flex items-center gap-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet text-[#21b3dd]">
                            <path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"></path>
                            <path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"></path>
                        </svg>
                        <span class="text-[12px] font-semibold text-[#AAAAAA]">Saldo</span>
                    </div>
                    <p class="text-[24px] font-medium text-white">R$ <?php echo e(number_format($availableBalance, 2, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-5 rounded-2xl bg-[#161616]">
                    ...
                    <p class="text-[24px] font-medium text-yellow-500">R$ <?php echo e(number_format($pendingBalance, 2, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-5 rounded-2xl bg-[#161616]">
                    ...
                    <p class="text-[24px] font-medium text-white">R$ <?php echo e(number_format($totalEntries, 2, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="hidden md:block overflow-x-auto p-5">
                <table class="w-full">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $paginator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-[#1f1f1f] hover:bg-[#161616] transition-colors">
                                <td class="py-3 px-4 text-[12px] font-semibold text-white">
                                    <?php echo e($movement['date']->format('d/m/Y H:i')); ?>

                                </td>
                                <td class="py-3 px-4">
                                    <span class="px-2 py-1 rounded text-[11px] font-semibold <?php echo e($movement['type'] == 'entry' ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'); ?>">
                                ...
                                <td class="py-3 px-4 text-[12px] font-semibold text-[#AAAAAA]">
                                    <?php echo e(strtoupper($movement['payment_method'])); ?>

                                </td>
                                <td class="py-3 px-4 text-[12px] font-semibold text-white text-right">
                                    R$ <?php echo e(number_format($movement['amount'], 2, ',', '.')); ?>

                                </td>
                                <td class="py-3 px-4 text-[12px] font-semibold text-[#AAAAAA] text-right">
                                    R$ <?php echo e(number_format($movement['fee'], 2, ',', '.')); ?>

                                </td>
                                <td class="py-3 px-4 text-[12px] font-semibold <?php echo e($movement['net_amount'] >= 0 ? 'text-green-500' : 'text-red-500'); ?> text-right">
                                    <?php echo e($movement['net_amount'] >= 0 ? '+' : ''); ?>R$ <?php echo e(number_format(abs($movement['net_amount']), 2, ',', '.')); ?>
                                ...
                                <td class="py-3 px-4">
                                    ...
                                    ?>
                                    <span class="px-2 py-1 rounded text-[11px] font-semibold <?php echo e($statusColor); ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $movement['status']))); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $paginator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 rounded-2xl bg-[#161616] space-y-3">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-[14px] font-semibold text-white"><?php echo e($movement['description']); ?></p>
                                <p class="text-[12px] font-semibold text-[#AAAAAA]"><?php echo e($movement['date']->format('d/m/Y H:i')); ?></p>
                            </div>
                            <span class="px-2 py-1 rounded text-[11px] font-semibold <?php echo e($movement['type'] == 'entry' ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'); ?>">
                                <?php echo e($movement['type_label']); ?>
                        ...
                        <div class="flex items-center justify-between pt-2 border-t border-[#1f1f1f]">
                            <div>
                                ...
                                <p class="text-[12px] font-semibold text-white"><?php echo e(strtoupper($movement['payment_method'])); ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-[12px] font-semibold text-[#AAAAAA]">Valor Líquido</p>
                                <p class="text-[14px] font-semibold <?php echo e($movement['net_amount'] >= 0 ? 'text-green-500' : 'text-red-500'); ?>">
                                    <?php echo e($movement['net_amount'] >= 0 ? '+' : ''); ?>R$ <?php echo e(number_format(abs($movement['net_amount']), 2, ',', '.')); ?>
            ...
            <?php if($paginator->hasPages()): ?>
                <div class="flex items-center justify-center w-full p-5">
                    <div class="flex items-center gap-2">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($paginator->previousPageUrl()); ?>" class="h-8 px-3 py-1 rounded-md flex items-center gap-1.5 bg-[#1f1f1f] hover:bg-[#2a2a2a] text-[#aaaaaa] hover:text-white transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-left h-3 w-3">
                                    <path d="m15 18-6-6 6-6"></path>
                                </svg>
                                <span class="text-[12px] font-semibold font-['Manrope'] tracking-[-0.24px]">Anterior</span>
                        ...
                        <?php if($paginator->hasMorePages()): ?>
                            <a href="<?php echo e($paginator->nextPageUrl()); ?>" class="h-8 px-3 py-1 rounded-md flex items-center gap-1.5 bg-[#1f1f1f] hover:bg-[#2a2a2a] text-[#aaaaaa] hover:text-white transition-colors">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u999974013/domains/playpayments.com/public_html/resources/views/revenues/index.blade.php ENDPATH**/ ?>