...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST" class="space-y-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Atribuição de Gateway</h3>
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                ...
                <!-- Withdrawal Type -->
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Configuração de Saque</h3>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                ...
                                >
                                <label for="withdrawal_manual" class="ml-2 text-sm text-gray-700">
                            ...
                            <div class="flex items-center">
                                <input 
                                    ...
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-600 bg-gray-800 rounded"
                                >
                                <label for="withdrawal_automatic" class="ml-2 text-sm text-gray-700">
                    ...
                    <div id="baas-selection" class="mt-6" style="<?php echo e($user->withdrawal_type === 'automatic' ? '' : 'display: none;'); ?>">
                        <label for="assigned_baas_id" class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Acessar Conta do Usuário</h3>
                    
                    <a 
                        href="<?php echo e(route('admin.users.login.as.user', $user)); ?>" 
                        class="w-full bg-orange-600 hover:bg-orange-700 text-gray-900 px-4 py-3 rounded-lg font-medium transition-all duration-200 block text-center"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium"><?php echo e($user->created_at ? $user->created_at->format('d/m/Y H:i') : 'N/A'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <!-- Current Gateway -->
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Gateway Atual</h3>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="block w-full bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm text-center transition-colors">
                        Ver Detalhes
                    </a>
                    
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="block w-full bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm text-center transition-colors">
                        Voltar à Lista
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>