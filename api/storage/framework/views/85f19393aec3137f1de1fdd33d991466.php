                                ...
                                <div class="p-4 rounded-lg flex items-center justify-between cursor-pointer bg-[#1f1f1f] hover:bg-[#2a2a2a]" onclick="window.location.href='<?php echo e(route('transactions.show', $transaction->transaction_id)); ?>'">
                                    <div class="flex flex-row gap-6 items-center">
                                        ...
                                        <div class="w-[120px]">
                                            ...
                                            ?>
                                            <p class="text-xs font-semibold tracking-[-0.24px] text-white truncate" title="<?php echo e($productName); ?>">
                                                <?php echo e($productNameDisplay); ?>

                                            </p>
                                            <?php if($transaction->products && is_array($transaction->products) && count($transaction->products) > 1): ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs1 gateway\resources\views/transactions/index.blade.php ENDPATH**/ ?>