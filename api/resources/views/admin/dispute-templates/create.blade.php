...
@section('title', 'Criar Template de Infração')
@section('page-title', 'Criar Template de Infração')
...
<div class="p-6 space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 rounded-2xl p-8 text-white shadow-xl">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">✨ Criar Novo Template</h1>
                <p class="text-purple-100">Crie um template reutilizável para infrações em massa</p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.setup.dispute-templates.store') }}" class="space-y-6">
        @csrf
        @include('admin.dispute-templates.form')
