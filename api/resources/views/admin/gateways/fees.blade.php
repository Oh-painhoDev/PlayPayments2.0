...
@section('title', 'Taxas do Gateway')
@section('page-title', 'Taxas do Gateway ' . $gateway->name)
@section('page-description', 'Configure as taxas que você paga para este gateway de pagamento')
...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('admin.gateways.fees.update', $gateway->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                max="100"
                                required 
                                value="{{ old('pix_percentage', $fees['pix']->percentage_fee) }}"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                min="0" 
                                required 
                                value="{{ old('pix_fixed', $fees['pix']->fixed_fee) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="0.00"
                            >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('pix_min', $fees['pix']->min_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="0.01"
                            >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('pix_max', $fees['pix']->max_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                max="100"
                                required 
                                value="{{ old('credit_card_percentage', $fees['credit_card']->percentage_fee) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="2.99"
                            >
                            <p class="text-xs text-gray-500 mt-1">Taxa percentual que você paga ao gateway</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                min="0" 
                                required 
                                value="{{ old('credit_card_fixed', $fees['credit_card']->fixed_fee) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="0.30"
                            >
                            <p class="text-xs text-gray-500 mt-1">Taxa fixa por transação</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('credit_card_min', $fees['credit_card']->min_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="0.50"
                            >
                            <p class="text-xs text-gray-500 mt-1">Valor mínimo da taxa (opcional)</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('credit_card_max', $fees['credit_card']->max_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="Sem limite"
                            >
                            <p class="text-xs text-gray-500 mt-1">Valor máximo da taxa (opcional)</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                max="100"
                                required 
                                value="{{ old('bank_slip_percentage', $fees['bank_slip']->percentage_fee) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="1.99"
                            >
                            <p class="text-xs text-gray-500 mt-1">Taxa percentual que você paga ao gateway</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                min="0" 
                                required 
                                value="{{ old('bank_slip_fixed', $fees['bank_slip']->fixed_fee) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="1.50"
                            >
                            <p class="text-xs text-gray-500 mt-1">Taxa fixa por transação</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('bank_slip_min', $fees['bank_slip']->min_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="2.00"
                            >
                            <p class="text-xs text-gray-500 mt-1">Valor mínimo da taxa (opcional)</p>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01" 
                                min="0" 
                                value="{{ old('bank_slip_max', $fees['bank_slip']->max_amount) }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="Sem limite"
                            >
                            <p class="text-xs text-gray-500 mt-1">Valor máximo da taxa (opcional)</p>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $gateway->name }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $gateway->api_url }}</p>
                    </div>
                    
                    <div>
                        <span class="text-sm text-gray-600">Tipo:</span>
                        <p class="text-gray-900 font-medium">{{ ucfirst($gateway->getConfig('gateway_type', 'avivhub')) }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('admin.gateways.edit', $gateway->id) }}" class="block w-full bg-blue-600 hover:bg-blue-700 text-gray-900 px-4 py-2 rounded-lg text-sm text-center transition-colors">
                        Editar Gateway
                    </a>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const gatewayFees = {
        pix: {
            percentage: {{ $fees['pix']->percentage_fee }},
            fixed: {{ $fees['pix']->fixed_fee }},
            min: {{ $fees['pix']->min_amount ?? 0 }},
            max: {{ $fees['pix']->max_amount ?? 'null' }}
        },
        credit_card: {
            percentage: {{ $fees['credit_card']->percentage_fee }},
            fixed: {{ $fees['credit_card']->fixed_fee }},
            min: {{ $fees['credit_card']->min_amount ?? 0 }},
            max: {{ $fees['credit_card']->max_amount ?? 'null' }}
        },
        bank_slip: {
            percentage: {{ $fees['bank_slip']->percentage_fee }},
            fixed: {{ $fees['bank_slip']->fixed_fee }},
            min: {{ $fees['bank_slip']->min_amount ?? 0 }},
            max: {{ $fees['bank_slip']->max_amount ?? 'null' }}
        }
    };
