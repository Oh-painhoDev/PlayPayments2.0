            ...
            <form action="{{ route('admin.baas.update') }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        name="is_default" 
                        value="1" 
                        {{ old('is_default', $strikeCashCredentials && $strikeCashCredentials->is_active) ? 'checked' : '' }}
            ...
            <form action="{{ route('admin.baas.update') }}" method="POST" class="space-y-6 mt-6">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        name="is_default" 
                        value="1" 
                        {{ old('is_default', $cashtimeCredentials && $cashtimeCredentials->is_active) ? 'checked' : '' }}
                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-600 bg-gray-800 rounded"
                    >
            ...
            <form action="{{ route('admin.baas.update') }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        name="is_default" 
                        value="1" 
                        {{ old('is_default', $e2bankCredentials && $e2bankCredentials->is_active) ? 'checked' : '' }}
                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-600 bg-gray-800 rounded"
                    >
