                                    ...
                                    <tr class="hover:bg-[#1f1f1f] transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2">
                                                <input type="text" value="{{ $link->checkout_url }}" readonly onclick="this.select()" class="px-3 py-1.5 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-xs font-mono w-[300px] focus:outline-none focus:ring-2 focus:ring-[#21b3dd]">
                                                <button onclick="copyToClipboard('{{ $link->checkout_url }}')" class="px-3 py-1.5 bg-[#1f1f1f] hover:bg-[#2d2d2d] border border-[#2d2d2d] rounded-lg text-[#21b3dd] text-xs font-semibold transition-colors">
                                                    Copiar
                                                </button>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                <button onclick="getIntegrationCode('{{ $link->slug }}')" class="px-3 py-1.5 bg-[#1f1f1f] hover:bg-[#2d2d2d] border border-[#2d2d2d] rounded-lg text-[#21b3dd] text-xs font-semibold transition-colors">
                                                    Código
                                                </button>
                    ...
                    <div id="modalPreviewContainer" class="bg-[#1f1f1f] border border-[#2d2d2d] rounded-xl p-6">
                        <div class="text-center space-y-4">
                            ...
                            <div class="bg-[#161616] border border-[#2d2d2d] rounded-lg p-4">
                                ...
                                <p id="previewLink" class="text-xs font-mono text-[#21b3dd] break-all">{{ url('/checkout') }}/...</p>
                            </div>
                        </div>
                    </div>
                </div>
