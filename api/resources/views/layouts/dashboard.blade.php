            ...
            <div class="flex flex-col h-full pt-10 pb-5">
                <div class="px-5 mb-6 relative flex-shrink-0">
                    <div class="flex items-center justify-center mb-4 relative">
                        <img alt="{{ config('app.name') }}" loading="lazy" width="110" height="27" decoding="async" data-nimg="1" class="h-[26.795px] w-[110px]" src="/images/playpayments-logo-top.webp" style="color: transparent;">
                                ...
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('dashboard') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('dashboard') }}">
                                        ...
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('dashboard') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('wallet.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('wallet.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('wallet.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('transactions.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('transactions.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('transactions.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('refunds.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('refunds.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('refunds.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('revenues.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('revenues.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('revenues.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('customers.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('customers.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('customers.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('payment-links.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('payment-links.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('payment-links.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('integracoes') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('integracoes') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('integracoes') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('api-key') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('api-key') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('api-key') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('webhooks.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('webhooks.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('webhooks.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    ...
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ $isSettingsActive ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('settings.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ $isSettingsActive ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                            ...
                            <div>
                                <div class="px-5">
                                    <a class="relative flex items-center w-full transition-all duration-200 py-2 {{ request()->routeIs('documents.*') ? 'text-white' : 'text-[#6B7280]' }}" href="{{ route('documents.index') }}">
                                        ...
                                        @endif
                                        <div class="flex items-center gap-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('documents.*') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}">
                    ...
                    <div class="flex flex-col gap-5 p-4 rounded-[6px] bg-[#1f1f1f]">
                        <div class="flex items-center gap-3">
                            <div class="relative w-9 h-9 rounded-full overflow-hidden flex-shrink-0">
                                ...
                                @endphp
                                @if($hasPhoto)
                                    <img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->name }}" class="w-full h-full object-cover sidebar-user-photo" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                    <div class="w-full h-full hidden items-center justify-center bg-[#21b3dd] text-white text-xs font-semibold">
                                        {{ $userInitials }}
                                    </div>
                                @else
                                    ...
                                    <div class="flex flex-col gap-1.5 justify-center min-w-[120px] sm:min-w-[210px]">
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="flex-1 rounded-[40px] p-[2px] bg-[#161616]">
                                                <div class="bg-[#21b3dd] h-[6px] rounded-[40px] transition-all duration-500" style="width: {{ min(100, $currentGoal['percentage']) }}%;"></div>
                                            </div>
                            ...
                            @if($currentGoal)
                                <div class="flex items-center gap-2 px-3 py-2 rounded-lg flex-1" style="background: transparent;">
                                    ...
                                    <div class="flex flex-col gap-1 justify-center flex-1 min-w-0">
                                        <div class="flex items-center gap-2 w-full">
                                            <div class="flex-1 rounded-[40px] p-[2px] bg-[#161616]">
                                                <div class="bg-[#21b3dd] h-[4px] rounded-[40px] transition-all duration-500" style="width: {{ min(100, $currentGoal['percentage']) }}%;"></div>
                                            </div>
