    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 border-r border-gray-800 flex flex-col bg-[#161616] shadow-sm">
            ...
            <div class="flex items-center justify-center px-6 py-4 border-b border-gray-800 flex-shrink-0">
                ...
                @endphp
                <img src="{{ $logoUrl }}" alt="{{ config('app.name') }}" class="h-8 w-auto" onerror="this.src='{{ asset('images/playpayments-logo-top.webp') }}'">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto scrollable-content">
                <!-- Dashboard -->
                <a href="{{ route('admin.dashboard') }}" class="nav-item relative {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200">
                    ...
                    @endif
                    <svg class="w-4 h-4 mr-3 {{ request()->routeIs('admin.dashboard') ? 'text-[#21b3dd]' : 'text-[#6B7280]' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- System Logs -->
                <a href="{{ route('admin.system-logs.index') }}" class="nav-item relative {{ request()->routeIs('admin.system-logs.*') ? 'active' : '' }} flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.system-logs.*') ? 'text-white' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200">
                ...
                <div class="space-y-1" x-data="{ open: {{ request()->routeIs('admin.goals.*') ? 'true' : 'false' }} }">
                    <button 
                        @click="open = !open"
                        class="nav-item flex items-center justify-between w-full px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.goals.*') ? 'text-white bg-[#1E1E1E]' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200"
                    >
                    ...
                    >
                        <!-- Goals Management -->
                        <a href="{{ route('admin.goals.index') }}" class="nav-item {{ request()->routeIs('admin.goals.*') ? 'active' : '' }} flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.goals.*') ? 'text-white bg-[#1E1E1E]' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                            </svg>
                            Gerenciar Metas
                ...
                <div class="space-y-1" x-data="{ open: {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.documents.*') || request()->routeIs('admin.transactions.*') || request()->routeIs('admin.withdrawals.*') || request()->routeIs('admin.billing.*') || request()->routeIs('admin.billing-period.*') || request()->routeIs('admin.profit.*') ? 'true' : 'false' }} }">
                    ...
                    >
                        ...
                        <a href="{{ route('admin.documents.index') }}" class="nav-item {{ request()->routeIs('admin.documents.*') ? 'active' : '' }} flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.documents.*') ? 'text-white bg-[#1E1E1E]' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        ...
                        <!-- Withdrawals -->
                        <a href="{{ route('admin.withdrawals.index') }}" class="nav-item {{ request()->routeIs('admin.withdrawals.*') ? 'active' : '' }} flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.withdrawals.*') ? 'text-white bg-[#1E1E1E]' : 'text-[#6B7280] hover:text-white hover:bg-[#1E1E1E]' }} transition-all duration-200">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Back to User Panel -->
                <a href="{{ route('dashboard') }}" class="nav-item flex items-center px-3 py-2 text-sm font-medium text-[#6B7280] hover:text-[#21b3dd] hover:bg-[#1E1E1E] rounded-lg transition-all duration-200">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
