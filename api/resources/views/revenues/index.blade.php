        ...
        <div class="bg-[#000000] rounded-2xl space-y-6">
            ...
            <div class="content-stretch flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between relative size-full p-5 gap-6 md:gap-0">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('revenues.export', request()->query()) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-[#21b3dd] hover:bg-[#21b3dd] text-white rounded-lg text-sm font-semibold transition-colors">
            ...
            <div class="box-border flex flex-col gap-2.5 items-start justify-start p-[20px] relative rounded-2xl shrink-0 w-full bg-[#161616]">
                <form method="GET" action="{{ route('revenues.index') }}" class="flex flex-col md:flex-row gap-4 w-full">
                    <div class="flex items-center gap-2">
                        ...
                        <input type="date" name="start_date" value="{{ $startDate }}" class="px-3 py-2 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#21b3dd]">
                        <span class="text-[#AAAAAA] text-sm">até</span>
                        <input type="date" name="end_date" value="{{ $endDate }}" class="px-3 py-2 bg-[#1f1f1f] border border-[#2d2d2d] rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#21b3dd]">
