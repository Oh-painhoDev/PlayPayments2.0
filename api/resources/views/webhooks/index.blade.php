                ...
                <ul class="space-y-4" id="webhooksList">
                    ...
                    @else
                        @foreach($webhooks as $webhook)
                            <li class="webhook-item bg-[#1f1f1f] rounded-lg p-4 border border-[#2d2d2d] hover:border-[#21b3dd]/50 transition-colors" data-description="{{ strtolower($webhook->description ?? '') }}" data-url="{{ strtolower($webhook->url) }}">
