 ...
 * 
 * Acesse via: http://localhost:8000/gerar-pagamento.php
 * 
 * ANTES DE USAR:
 * 1. Edite a variável $apiSecret abaixo e coloque seu token de API (Secret Key)
 * 2. Ajuste os dados do pagamento conforme necessário
 */

// ============================================
// CONFIGURAÇÕES
// ============================================
$baseUrl = 'http://localhost:8000'; // URL base da API (subdomínio api)
...
// ============================================
function criarPagamento($baseUrl, $apiSecret, $paymentData) {
    // URL da API v1
...
// EXECUTAR REQUISIÇÃO
// ============================================
$result = criarPagamento($baseUrl, $apiSecret, $paymentData);
...
if ($isBrowser) {
    ...
    <body>
        <div class="container">
            ...
            <div class="card">
                <h2>📋 Informações</h2>
                <p><strong>URL da API:</strong> <code><?= htmlspecialchars($baseUrl) ?>/api/v1/transactions</code></p>
